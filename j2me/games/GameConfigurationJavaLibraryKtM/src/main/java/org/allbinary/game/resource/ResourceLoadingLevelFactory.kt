...
open public class ResourceLoadingLevelFactory : Object {
    ...
    private val RESOURCE_LOADING_LEVEL_ARRAY: Array<ResourceLoadingLevel?> =
        arrayOf(
            this.LOAD_ALL,
            this.MAX_LEVEL,
            this.LEVEL,
    ...
    open fun getLevelString(
        ...
        for (index in 0 until this.RESOURCE_LOADING_LEVEL_ARRAY.size) {

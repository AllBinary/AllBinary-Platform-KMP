...
open public class GameInputMappingInstructionsCanvas : GameCommandCanvas {
    ...
    companion object {
        ...
        val DISPLAY: Command =
            Command("Help", StringUtil.getInstance()!!.EMPTY_STRING, Command.SCREEN, 1)

        val CLOSE: Command =
            Command("Close", StringUtil.getInstance()!!.EMPTY_STRING, Command.SCREEN, 1)
    ...
    public constructor(
        ...
        commandListener,
        GameInputMappingInstructionsCanvas.NAME,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.drawStringUtil!!.drawCenterStrings(
            graphics,
            this.instructions,

...
open public class CombatBaseBehavior : Object {

    companion object {

        val NULL_COMBAT_BEHAVIOR: CombatBaseBehavior =
            CombatBaseBehavior(
                DamageableBaseBehavior.getInstance(),
                DestroyableBaseBehavior.getInstance(),
            )
    }
    ...
    public constructor(
        damageableBaseBehavior: DamageableBaseBehavior,

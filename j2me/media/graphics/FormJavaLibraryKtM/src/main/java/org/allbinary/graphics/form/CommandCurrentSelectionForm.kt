...
open public class CommandCurrentSelectionForm : ScrollCurrentSelectionForm, UpdateMyFontInterface {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (J2MEUtil.isJ2ME()) {
            ...
            this.selectedAnimationArray[index] =
                RectangleFilledAdjustedAnimation(
                    rectWidth,
                    rectHeight,
                    offset,
                    offset,
        ...
        if (J2MEUtil.isJ2ME()) {
            ...
            this.unSelectedAnimationArray[index] =
                RectangleFilledAdjustedAnimation(rectWidth, rectHeight, offset, offset, buttonColor)
        }
    }
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (J2MEUtil.isJ2ME()) {
            ...
            var rectangleAdjustedAnimation: RectangleFilledAdjustedAnimation =
                this.selectedAnimationArray[index]!! as RectangleFilledAdjustedAnimation
        ...
        if (J2MEUtil.isJ2ME()) {
            ...
            var rectangleAdjustedAnimation: RectangleFilledAdjustedAnimation =
                this.unSelectedAnimationArray[index]!! as RectangleFilledAdjustedAnimation
    ...
    @Throws(Exception::class)
    override fun paintUnselectedItem(
        graphics: Graphics,
        index: Int,
        item: ABCustomItem,
        x: Int,

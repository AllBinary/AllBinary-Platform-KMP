...
open public class ScaleProperties : Object {
    ...
    : String {
        ...
        return StringMaker()
            ...
            .appendboolean(this.shouldScale)!!
            .append("scaleX: ")!!
            .appendfloat(this.scaleX)!!
            .append("scaleY: ")!!
            .appendfloat(this.scaleY)!!
            .append("scaleWidth: ")!!
            .appendint(this.scaleWidth)!!
            .append("scaleHeight: ")!!
            .appendint(this.scaleHeight)!!
            .toString()
    }
}

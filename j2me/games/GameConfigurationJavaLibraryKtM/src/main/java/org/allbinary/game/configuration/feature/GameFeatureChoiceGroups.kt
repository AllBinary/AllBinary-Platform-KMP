...
open public class GameFeatureChoiceGroups : Object {

    companion object {

        private var gameFeatureChoiceGroupsExclusive: GameFeatureChoiceGroups =
            GameFeatureChoiceGroups()

        private var gameFeatureChoiceGroupsMultiple: GameFeatureChoiceGroups =
            GameFeatureChoiceGroups()

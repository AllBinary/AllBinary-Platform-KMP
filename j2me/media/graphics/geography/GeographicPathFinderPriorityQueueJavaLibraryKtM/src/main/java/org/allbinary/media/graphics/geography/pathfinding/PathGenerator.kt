...
open public class PathGenerator : Object, PathGeneratorInterface {
    ...
    open fun getInstanceNoCache(
        ...
        var geographicMapCellPositionBasicArrayList: BasicArrayList =
            this.create(geographicMapInterface, pathFindingInfo, totalPaths)!!
    ...
    open fun create(
        ...
        var startPathFindingNodeList: BasicArrayList =
            pathFindingInfo!!.getStartPathFindingNodeList()!!

        var endPathFindingNodeList: BasicArrayList = pathFindingInfo!!.getEndPathFindingNodeList()!!

        var geographicPathFinderInterface: GeographicPathFinderBase =
            pathFindingInfo!!.getPathFinder()!!

        var geographicMapCellPositionBasicArrayList: BasicArrayList =
            geographicPathFinderInterface!!.searchTotalPath(
                startPathFindingNodeList,
                endPathFindingNodeList,
                totalPaths,
            )!!
    ...
    open fun createN(
        ...
        var geographicMapCellPositionBasicArrayList: BasicArrayList =
            geographicPathFinderInterface!!.searchTotalPathN(
                startPathFindingNodeList,
                endPathFindingNodeList,
                totalPaths,
                multipassState,

...
open public class PathFindingInfoFactory : BasePathFindingInfoFactory {
    ...
    private constructor() {
        this.pathFindingInfo =
            PathFindingInfo(
                PathFindingNodeCostInfoFactory(PathFindingInfoFactory.MAX),
                BasicArrayListS(1),
                BasicArrayListS(1),
            )
    ...
    override fun getInstancePathFindingInfo(
    ...
    @Throws(Exception::class)
    open fun buildPathFindingNodesForCellPosition(
        geographicMapInterface: BasicGeographicMap,
        pathFindingInfo: PathFindingInfo,
        mapArray: Array<IntArray?>,
    ...
    @Throws(Exception::class)
    open fun buildPathFindingNodes(
        geographicMapInterface: BasicGeographicMap,
        pathFindingInfo: PathFindingInfo,
        mapArray: Array<IntArray?>,
    )

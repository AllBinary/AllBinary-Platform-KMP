...
open public class AllBinaryAndroidImageRotationAnimationFactory : BaseImageAnimationFactory {
    ...
    companion object {
        ...
        open fun createFactory(
            ...
            return AllBinaryAndroidImageRotationAnimationFactory(
                image,
                width,
                height,
        ...
        open fun createFactoryU(
            ...
            var androidImageRotationAnimationFactory:
                AllBinaryAndroidImageRotationAnimationFactory =
                AllBinaryAndroidImageRotationAnimationFactory(
                    image,
                    image.getWidth(),
            ...
            androidImageRotationAnimationFactory!!.init(
        ...
        open fun createFactoryADXY(
            ...
            angleIncrement: Short,
            animationBehaviorFactory: AnimationBehaviorFactory,
            resizeCanvasForRotation: Boolean,
        )
            // nullable = true from not(false or (false and false)) = true
            : AllBinaryAndroidImageRotationAnimationFactory {
            // var image = image
    ...
    override fun getInstance(
        ...
        if (
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinaryAdjustedAndroidImageRotationAnimation(
                scaledImage,
                copyOfScaledImage,
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinaryFlickerAndroidImageRotationAnimation(
                scaledImage,
                copyOfScaledImage,
                AngleInfo.getInstance(this.angleIncrement),
                AngleFactory.getInstance()!!.TOTAL_ANGLE,

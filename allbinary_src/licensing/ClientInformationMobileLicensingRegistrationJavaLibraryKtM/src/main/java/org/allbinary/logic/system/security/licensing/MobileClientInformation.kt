...
open public class MobileClientInformation : AbeClientInformation {
    ...
    public constructor(
        ...
        StringMaker()
            ...
            .append(PartnerIdentifierFileUtil.getInstance()!!.get())!!
            .toString(),
        shortName,
    ) {
        // var name = name
    ...
    : Hashtable<Any, Any> {
        ...
        var registrationConfiguration: RegistrationConfiguration =
            RegistrationConfiguration.getInstance()!!

        hashtable.put(
            registrationConfiguration!!.NAME,
            registrationConfiguration!!.getRegistrationCode(),
        )

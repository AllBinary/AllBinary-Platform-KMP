...
open public class GeographicMapCellPositionEventUtil : Object {

    private val geographicMapCellPositionEvent: GeographicMapCellPositionEvent

    private val geographicMapCellPositionEventHandler: GeographicMapCellPositionEventHandler =
        GeographicMapCellPositionEventHandler.getInstance()!!

    public constructor(anyType: Any) : super() {
        var anyType = anyType
        this.geographicMapCellPositionEvent =
            GeographicMapCellPositionEvent(anyType, CellPositionFactory.getInstance()!!.NONE)
    }

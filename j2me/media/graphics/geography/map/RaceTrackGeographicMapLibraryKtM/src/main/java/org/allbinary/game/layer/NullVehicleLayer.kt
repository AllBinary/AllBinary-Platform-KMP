...
open public class NullVehicleLayer : Object, VehicleLayerInterface {
    ...
    override fun setGeographicMapCellHistoryArray(
        geographicMapCellHistory: Array<GeographicMapCellHistory?>
    )
        // nullable = true from not(false or (false and false)) = true
    {

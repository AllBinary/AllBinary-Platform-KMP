...
open public class DiagonalUpRightTouchInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                DiagonalUpRightTouchInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                DiagonalUpRightTouchInputToGameKeyEventAction.instance =
                    DiagonalUpRightTouchInputToGameKeyEventAction()
            }

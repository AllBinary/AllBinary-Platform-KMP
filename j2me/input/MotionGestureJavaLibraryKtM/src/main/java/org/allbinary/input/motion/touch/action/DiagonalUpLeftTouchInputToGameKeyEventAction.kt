...
open public class DiagonalUpLeftTouchInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                DiagonalUpLeftTouchInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                DiagonalUpLeftTouchInputToGameKeyEventAction.instance =
                    DiagonalUpLeftTouchInputToGameKeyEventAction()
            }

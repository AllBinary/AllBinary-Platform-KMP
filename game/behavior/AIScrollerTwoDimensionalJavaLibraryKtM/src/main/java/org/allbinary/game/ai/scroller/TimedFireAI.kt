...
open public class TimedFireAI : BasicAI {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var timeFiredInterface: TimeFiredInterface =
            this.getOwnerLayerInterface() as TimeFiredInterface

        if (
            this.maxFireDelayTimeHelper!!.isTime(
                GameTickTimeDelayHelperFactory.getInstance()!!.startTime
            ) &&
                timeFiredInterface!!.getLastFireTime() + this.maxFireDelayTimeHelper!!.delay <
                    this.maxFireDelayTimeHelper!!.getStartTime()
        ) {

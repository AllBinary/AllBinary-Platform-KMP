...
open public class TechRTSFormInput : RTSFormInput {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var technologyRTSInterfaceImageItem: TechnologyRTSInterfaceImageItem =
            item as TechnologyRTSInterfaceImageItem

        var rtsInterface: RTSInterface = technologyRTSInterfaceImageItem!!.getRtsInterface()!!

        this.logUtil!!.putF(
            stringMaker!!
                .append("isUpgradeable: ")!!
                .appendboolean(rtsInterface!!.isUpgradeable())!!
                .toString(),
            this,

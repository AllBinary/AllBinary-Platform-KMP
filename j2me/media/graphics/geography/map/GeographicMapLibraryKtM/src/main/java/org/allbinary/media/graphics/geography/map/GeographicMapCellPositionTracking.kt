...
open public class GeographicMapCellPositionTracking : Object {
    ...
    open fun getCurrentOverCellType(
        geographicMap: BasicGeographicMap
    )
    ...
    @Throws(Exception::class)
    open fun updateStart(
        gameCanvasInterface: AllBinaryGameCanvasInterface,
        ...
        if (
            ...
            var geographicMapCompositeInterface: GeographicMapCompositeInterface =
                gameCanvasInterface!!.getLayerManager() as GeographicMapCompositeInterface

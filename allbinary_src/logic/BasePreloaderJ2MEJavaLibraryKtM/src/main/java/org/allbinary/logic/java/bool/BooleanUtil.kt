...
open public class BooleanUtil : Object {
    ...
    open fun getFromString(
        ...
        if (this.tsUtil!!.compareTo(booleanStringLowerCase, booleanFactory!!.TRUE_STRING) == 0) {
            ...
            this.tsUtil!!.compareTo(booleanStringLowerCase, booleanFactory!!.FALSE_STRING) == 0
        ) {
    ...
    open fun isStringBoolean(
        ...
        if (
            booleanStringLowerCase!!.compareTo(booleanFactory!!.TRUE_STRING) == 0 ||

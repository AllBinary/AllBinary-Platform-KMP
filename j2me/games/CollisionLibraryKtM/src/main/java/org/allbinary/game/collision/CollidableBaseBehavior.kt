...
open public class CollidableBaseBehavior : Object, CollidableInterface {
    ...
    public constructor(collidable: Boolean) : super() {
    ...
    override fun collide(
        ownerLayer: CollidableCompositeLayer,
        allbinaryCollidableLayer: CollidableCompositeLayer,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        // var ownerLayer = ownerLayer
    ...
    open fun isCollisionInterface(
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return this.layerCollisionUtil!!.isCollision(
            ownerLayer,

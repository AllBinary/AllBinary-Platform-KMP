...
open public class AdvancedRTSProperties : Object {
    ...
    companion object {
        ...
        : AdvancedRTSProperties {
            ...
            return AdvancedRTSProperties(
                NoShakeAnimationListener.NO_SHAKE_ANIMATION_LISTENER,
                AllBinaryNoVibration.NO_VIBRATION,
                0,
        ...
        : AdvancedRTSProperties {
            ...
            return AdvancedRTSProperties(
                ...
                AllBinaryVibration.getInstance(),
                GameConfigurationCentral.getInstance()!!.VIBRATION.getValue()!!.toInt() * 100,
                WaypointBehaviorBase(),
            )
        }
    }
    ...
    public constructor(
        shakeListener: ShakeAnimationListener,
        vibration: AllBinaryVibrationME,
        duration: Int,
        waypointBehaviorBase: TickableInterface,
    ) : super() {

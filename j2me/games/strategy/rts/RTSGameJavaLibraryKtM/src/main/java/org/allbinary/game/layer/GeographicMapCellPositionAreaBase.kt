...
open public class GeographicMapCellPositionAreaBase :
    Object, GeographicMapCellPositionAreaInterface {

    companion object {

        val NULL_GEOGRPAHIC_MAP_POSITION_AREA_BASE: GeographicMapCellPositionAreaBase =

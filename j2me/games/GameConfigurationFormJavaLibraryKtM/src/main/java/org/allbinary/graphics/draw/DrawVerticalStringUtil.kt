...
open public class DrawVerticalStringUtil : Object {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in size - 1 downTo 0) {
            ...
            graphics.drawChar(
                aChar,
                x + this.offsetXArray[index],
                y + (this.charHeight * index) + this.offsetY,
                anchor,
            )
        }
    }
            ...
            if (string != this.EMPTY_STRING) {
                ...
                while (offset < size) {
                    ...
                    this.drawCenterString(
                        ...
                        currentLength,
                        x,
                        y + ((index + extraLines++) * this.charHeight),
                    )

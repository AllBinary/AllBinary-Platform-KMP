...
open public class PCClipWavPlayer : BasicPlayer, LineListener {
    ...
    public constructor(inputStream: InputStream) {
        ...
        var audioInputStream: AudioInputStream =
            AudioInputStream(
                ByteArrayInputStream(NullUtil.getInstance()!!.NULL_BYTE_ARRAY),
                NullAudioFormat.NULL_AUDIO_FORMAT,
                0,
            )
    ...
    {
        MusicThreadPool.getInstance()!!.runTask(
            object : ARunnable() {
    ...
    : Float {
        ...
        var masterGainFloatControl: FloatControl =
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var masterGainFloatControl: FloatControl =
            this.clip.getControl(FloatControl.Type.MASTER_GAIN) as FloatControl

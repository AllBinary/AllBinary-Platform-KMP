...
open public class GroupLayerManagerListener : LayerManagerEventListener {
    ...
    open fun getGroupSizeFromInterface(
    ...
    open fun areAllOtherGroupsEmpty(
        groupInterface: Group
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {
        ...
        for (index in size - 1 downTo 0) {
            ...
            if (id != index) {
                ...
                if (groupSize != 0) {
                    ...
                    this.logUtil!!.putF(
                        StringMaker().append("Group Size: ")!!.appendint(groupSize)!!.toString(),
                        this,
    ...
    open fun isIdInList(
        id: Int,
        excludeGroupList: BasicArrayList,
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {
        // var id = id
    ...
    open fun areAllOtherGroupsLessThan(
        excludeGroupList: BasicArrayList,
        maxSize: Int,
    )
        // nullable = true from not(false or (false and false)) = true
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in 0 until size) {
            ...
            if (groupList == null) {
                ...
                this.logUtil!!.putF(
                    StringMaker().append("id: ")!!.appendint(id)!!.toString(),
                    this,

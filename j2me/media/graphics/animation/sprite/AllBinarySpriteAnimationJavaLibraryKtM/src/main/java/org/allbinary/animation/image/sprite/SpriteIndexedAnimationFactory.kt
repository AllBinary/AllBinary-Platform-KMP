...
open public class SpriteIndexedAnimationFactory :
    ...
    companion object {
        ...
        open fun createCWH(
            ...
            var spriteIndexedAnimationFactory: SpriteIndexedAnimationFactory =
                SpriteIndexedAnimationFactory(
                    image,
                    basicColorArray,
                    PrimitiveIntUtil.getArrayInstance(),
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        this.animationFactoryInitializationVisitor!!.dx =
            -(this.animationFactoryInitializationVisitor!!.width shr 2)
        this.animationFactoryInitializationVisitor!!.dy =
            -(this.animationFactoryInitializationVisitor!!.height shr 2)
    ...
    override fun getInstance(
        ...
        if (
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AdjustedSpriteIndexedAnimation(
                sprite,
                this.getImage(),
                this.basicColorArray,
                this.animationFactoryInitializationVisitor!!.dx,
                this.animationFactoryInitializationVisitor!!.dy,

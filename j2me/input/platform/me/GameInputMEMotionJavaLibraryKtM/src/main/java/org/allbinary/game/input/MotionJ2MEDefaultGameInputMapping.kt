...
open public class MotionJ2MEDefaultGameInputMapping : PersistentInputMapping {
    ...
    public constructor() :
        ...
        inputToGameKeyMapping!!.add(
            gameKeyFactory!!.UP,
            TouchMotionGestureFactory.getInstance()!!.UP,
        )
        inputToGameKeyMapping!!.add(
            gameKeyFactory!!.DOWN,
            TouchMotionGestureFactory.getInstance()!!.DOWN,
        )
        inputToGameKeyMapping!!.add(
            gameKeyFactory!!.LEFT,
        ...
        inputToGameKeyMapping!!.add(
            ...
            TouchMotionGestureFactory.getInstance()!!.RIGHT,
        )
        ...
        inputToGameKeyMapping!!.add(
            ...
            basicTouchInputFactory!!.SPECIAL_BUTTON_FOUR,
        )
        inputToGameKeyMapping!!.add(
            gameKeyFactory!!.KEY_NUM9,
            basicTouchInputFactory!!.SPECIAL_BUTTON_THREE,
        )
        inputToGameKeyMapping!!.add(

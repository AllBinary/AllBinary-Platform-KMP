...
open public class MotionEventFactory : Object, AllBinaryEventObjectFactoryInterface {
    ...
    public constructor(source: Any, id: Int) : super() {
        var source = source
        var id = id
        this.source = source
        this.id = id
    ...
    : AllBinaryEventObject {
        ...
        if (input == inputFactory!!.NO_INPUT) {
            ...
            return MotionGestureEvent(
                this.source,
                this.id,
                TouchMotionGestureFactory.getInstance()!!.NO_MOTION as MotionGestureInput,
            )
        } else {

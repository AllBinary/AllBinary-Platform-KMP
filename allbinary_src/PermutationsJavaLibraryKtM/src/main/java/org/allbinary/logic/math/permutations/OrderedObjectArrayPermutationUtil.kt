...
open public class OrderedObjectArrayPermutationUtil : Object {

    companion object {

        private val instance: OrderedObjectArrayPermutationUtil =
            ...
            // nullable = true from not(false or (false and false)) = true
        {
            ...
            var data: Array<Any?> = arrayOfNulls(TOTAL)
            ...
            var permutationVisitor: ObjectPermutationVisitor = ObjectPermutationVisitor(data)

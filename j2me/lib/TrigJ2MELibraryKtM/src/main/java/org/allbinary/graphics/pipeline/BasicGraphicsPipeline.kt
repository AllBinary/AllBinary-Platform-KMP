...
open public class BasicGraphicsPipeline : Object {

    var pointBasicArrayList: BasicArrayList

    public constructor(points: BasicArrayList) : super() {
        var points = points
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in 0 until size) {
            ...
            if (secondPoint!!.getX() != 1000) {
                ...
                newBasicArrayList!!.add(
                    pointFactory!!.createXY(secondPoint!!.getX() + x, secondPoint!!.getY() + y)
                )
            } else {

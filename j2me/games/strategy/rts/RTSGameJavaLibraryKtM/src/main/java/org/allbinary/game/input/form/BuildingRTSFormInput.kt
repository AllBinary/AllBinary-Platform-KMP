...
open public class BuildingRTSFormInput : RTSFormInput {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.buildOnPathGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
        this.spotTakenGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
        this.selectBuildSpotGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
        ...
        this.structureToCloseCollisionGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
        this.buildingGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
        this.mapEdgeGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
    }
    ...
    open fun isDemoLocked(
        ...
        var layerInterfaceFactoryInterface: DemoLockedWithCostLayerInterfaceFactoryInterface =
            factoryItem!!.getLayerInterfaceFactoryInterface()
                as DemoLockedWithCostLayerInterfaceFactoryInterface

        if (
            LockedUtil.getInstance()!!.isLocked() && layerInterfaceFactoryInterface!!.isDemoLocked()
        ) {
        ...
        if (
            ...
            if (!this.isPositionBlocked()) {
                ...
                var geographicMapCellType: GeographicMapCellType =
                    geographicMapInterface!!.getCellTypeAt(geographicMapCellPosition)!!
    ...
    open fun attemptBuild(
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append("Layer: ")!!
                .append(StringUtil.getInstance()!!.toString(layerInterface))!!
                .toString(),
            this,
            "attemptBuild",
        )
    ...
    open fun isSurroundingCellsOffMap(
        layerInterface: RTSLayer
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {

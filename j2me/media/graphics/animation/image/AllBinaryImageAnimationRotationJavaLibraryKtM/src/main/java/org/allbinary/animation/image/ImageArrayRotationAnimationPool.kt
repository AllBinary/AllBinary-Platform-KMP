...
open public class ImageArrayRotationAnimationPool : BasicArrayListResetablePool {
    ...
    companion object {
        ...
        private var IMAGE_ROTATION_ANIMATION_POOL: PoolInterface =
            ImageArrayRotationAnimationPool(ImageArrayRotationAnimationCacheableInterfaceFactory())
    ...
    override fun remove(
        ...
        var allBinaryImageRotationAnimationInfo: ImageArrayRotationAnimationInfo =
            key as ImageArrayRotationAnimationInfo

        var imageArrayRotationAnimationCacheable: ImageArrayRotationAnimationCacheable =
            (cacheableInterface as ImageArrayRotationAnimationCacheable)

        imageArrayRotationAnimationCacheable!!.setImageArray(

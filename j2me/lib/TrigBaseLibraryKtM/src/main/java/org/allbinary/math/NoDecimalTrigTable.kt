...
open public class NoDecimalTrigTable : Object {
    ...
    private constructor() : super() {
        ...
        this.noDecimalSin = LongArray(TOTAL_ANGLE)
        this.noDecimalCos = LongArray(TOTAL_ANGLE)
        this.noDecimalTan = LongArray(TOTAL_ANGLE + 1)
    ...
    open fun antiTan(
        ...
        if ((dx >= 0 && dy < 0)) {
            ...
            for (index in (this.noDecimalTan!!.size - 1) downTo 270) {
            ...
            for (index2 in 0 until dy.size) {
                ...
                PreLogUtil.put(
                    stringMaker!!
                        ...
                        .appendint(dy[index2]!!)!!
                        .append(TARGET_ANGLE)!!
                        .appendshort(angleOfTarget)!!
                        .append(CommonSeps.getInstance()!!.EQUALS)!!
                        .appendshort(angle.getValue())!!
                        .toString(),
                    this,
                    METHOD_NAME,
                )

...
open public class RaceTrackData : Object {
    ...
    private var overPassGeographicMapCellPositionArray: Array<CellPosition?> =
    ...
    public constructor(
        ...
        miniCellWidth: Int,
        miniCellHeight: Int,
        cellTypeIdToGeographicMapCellTypeArray: IntArray,
    ...
    open fun setCellTypeIdToGeographicMapCellTypeArray(
        cellTypeIdToGeographicMapCellTypeArray: IntArray
    )
        // nullable = true from not(false or (false and false)) = true
    {
    ...
    open fun setOverPassGeographicMapCellPositionArray(
        overPassGeographicMapCellPositionArray: Array<CellPosition?>
    )
        // nullable = true from not(false or (false and false)) = true
    {

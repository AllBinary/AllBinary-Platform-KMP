...
open public class RTSLayerCompositePaintable : Paintable {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (rtsLayer!!.isUpgradeable()) {
            ...
            this.setUpgradeCost(
                StringMaker()
                    .append(this.UPGRADE)!!
                    .appendint(rtsLayer!!.getUpgradeCost())!!
                    .toString()
            )
        } else {
        ...
        if (rtsLayer!!.isDowngradeable()) {
            ...
            this.setDownGradeCost(
                StringMaker()
                    .append(this.DOWNGRADE)!!
                    .appendint(rtsLayer!!.getDowngradeCost())!!
                    .toString()
            )
        } else {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        graphics.drawString(
            this.getDownGradeCost(),
            this.upgradableRTSLayerHudPaintable!!.textX,
            this.upgradableRTSLayerHudPaintable!!.costY1,
            0,
        )
        graphics.drawString(
            this.getUpgradeCost(),
            this.upgradableRTSLayerHudPaintable!!.textX,
            this.upgradableRTSLayerHudPaintable!!.costY,
            0,
        )
    }

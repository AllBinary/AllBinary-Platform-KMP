...
open public class PathFindingNodeCostInfoFactory : PathFindingNodeCostInfoFactoryBase {
    ...
    override fun getTotalCost(
        ...
        var geographicMapCellType: GeographicMapCellType =
            geographicMapInterface!!.getCellTypeAt(comingFromGeographicMapCellPosition)!!

        var geographicMapCellType2: GeographicMapCellType =
        ...
        var raceTrackGeographicMapCellType2: RaceTrackGeographicMapCellType =
            geographicMapCellType2 as RaceTrackGeographicMapCellType

        // if statement needs to be on the same line and ternary does not work the same way.
        return raceTrackGeographicMapCellType!!.getTravelCost().toLong() +

...
open public class Waypoint2LogHelper : Object {
    ...
    open fun processPossibleTargetCloser(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        unitWaypointBehavior2: WaypointBehaviorBase,
        layerInterface: PathFindingLayerInterface,
        anotherTargetDistance: Int,
    ...
    open fun setTargetPathIgnoreNewPath(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        unitWaypointBehavior2: WaypointBehaviorBase,
    )
        // nullable = true from not(false or (false and false)) = true
    ...
    open fun processWaypointTracked(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        unitWaypointBehavior2: WaypointBehaviorBase,
    )
        // nullable = true from not(false or (false and false)) = true
    ...
    open fun processWaypointTrackedVisit(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
    ...
    open fun processWaypointTrackedWithoutProgress(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        reason: String,
    )
        // nullable = true from not(false or (false and false)) = true
    ...
    open fun processTargetingNonWayPoint(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        dx: Int,
        dy: Int,
    )

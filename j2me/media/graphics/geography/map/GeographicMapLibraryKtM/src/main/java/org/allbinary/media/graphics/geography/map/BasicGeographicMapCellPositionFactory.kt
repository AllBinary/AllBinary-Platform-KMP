...
open public class BasicGeographicMapCellPositionFactory : Object {
    ...
    public constructor(geographicMapInterface: BasicGeographicMap) : super() {
        // var geographicMapInterface = geographicMapInterface
        this.geographicMapInterface = geographicMapInterface
        this.geographicMapCellPositionFactoryInterface =
            this.geographicMapInterface!!.getGeographicMapCellPositionFactoryInterface()
        ...
        this.geographicMapCellPositionArray =
            Array(this.rows) { arrayOfNulls<GeographicMapCellPosition?>(this.columns) }
    ...
    {
        // var geographicMapCelPositionFactoryInitVisitorInterface =
        // geographicMapCelPositionFactoryInitVisitorInterface
        ...
        try {
            ...
            for (column in 0 until columns) {
                ...
                for (row in 0 until rows) {
                    ...
                    geographicMapCelPositionFactoryInitVisitorInterface!!.visit(
                        tiledLayer,
                        cellPosition,
                    )
                }
    ...
    open fun getInstance(
        anotherMapGeographicMapCellPosition: GeographicMapCellPosition
    )
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return this.getAt(
            anotherMapGeographicMapCellPosition!!.getColumn(),
    ...
    open fun createInstance(
        ...
        if (cellPositionCanBeNull == null) {
            ...
            cellPositionCanBeNull =
                this.geographicMapCellPositionFactoryInterface!!.getInstance(
            ...
            this.geographicMapCellPositionArray[i_row]!![i_column] =
                cellPositionCanBeNull as GeographicMapCellPosition
        }

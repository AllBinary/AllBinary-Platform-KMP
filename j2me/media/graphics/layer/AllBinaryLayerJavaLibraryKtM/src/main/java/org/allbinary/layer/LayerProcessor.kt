...
open public class LayerProcessor : Object, LayerProcessorInterface {

    val commonStrings: CommonStrings = CommonStrings.getInstance()!!

    private val layerManager: LayerManager

    public constructor(layerManager: LayerManager) : super() {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in 0 until size) {
            ...
            this.processAt(
                ...
                layerManager!!.getLayerAt(index) as AllBinaryLayer,
                index,
            )
        }
    }

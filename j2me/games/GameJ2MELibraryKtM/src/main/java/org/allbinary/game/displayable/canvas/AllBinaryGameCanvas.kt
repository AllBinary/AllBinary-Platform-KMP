...
this.closeMenu()
    ...
    var items: Array<ABCustomItem?> = commandTextItemArrayFactory!!.getInstance(this.getCommandStack(), this.gameLayerManager!!.getBackgroundBasicColor(), this.gameLayerManager!!.getForegroundBasicColor())!!

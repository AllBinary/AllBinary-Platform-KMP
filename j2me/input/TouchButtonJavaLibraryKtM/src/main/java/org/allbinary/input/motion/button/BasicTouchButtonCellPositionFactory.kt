...
open public class BasicTouchButtonCellPositionFactory : Object {
    ...
    public constructor() : super() {
        ...
        this.BOTTOM_SECOND_FROM_RIGHT =
            cellPositionFactory!!.getInstanceColRow(
                touchButtonLocationHelper!!.getTotalColumns() - 2,
                touchButtonLocationHelper!!.getTotalRows() - 1,
            )
        this.SECOND_FROM_BOTTOM_RIGHT =
            cellPositionFactory!!.getInstanceColRow(
                touchButtonLocationHelper!!.getTotalColumns() - 1,
                touchButtonLocationHelper!!.getTotalRows() - 2,
            )
        this.SECOND_FROM_BOTTOM_SECOND_FROM_RIGHT =
            cellPositionFactory!!.getInstanceColRow(
                touchButtonLocationHelper!!.getTotalColumns() - 2,
                touchButtonLocationHelper!!.getTotalRows() - 2,
            )
        this.BOTTOM_SECOND_FROM_LEFT =
            cellPositionFactory!!.getInstanceColRow(
                1,
                touchButtonLocationHelper!!.getTotalRows() - 1,
            )
        this.SECOND_FROM_BOTTOM_LEFT =
            cellPositionFactory!!.getInstanceColRow(
                0,
                touchButtonLocationHelper!!.getTotalRows() - 2,
            )
        this.SECOND_FROM_BOTTOM_SECOND_FROM_LEFT =
            cellPositionFactory!!.getInstanceColRow(
                1,
                touchButtonLocationHelper!!.getTotalRows() - 2,
            )
        ...
        if (touchButtonLocationHelper!!.getTotalRows() >= 4) {
            ...
            this.THIRD_FROM_BOTTOM_RIGHT =
                cellPositionFactory!!.getInstanceColRow(
                    touchButtonLocationHelper!!.getTotalColumns() - 1,
                    touchButtonLocationHelper!!.getTotalRows() - 3,
                )
            this.FOURTH_FROM_BOTTOM_RIGHT =
                cellPositionFactory!!.getInstanceColRow(
                    touchButtonLocationHelper!!.getTotalColumns() - 1,
                    touchButtonLocationHelper!!.getTotalRows() - 4,
                )
            this.THIRD_FROM_BOTTOM_LEFT =
                cellPositionFactory!!.getInstanceColRow(
                    0,
                    touchButtonLocationHelper!!.getTotalRows() - 3,
                )

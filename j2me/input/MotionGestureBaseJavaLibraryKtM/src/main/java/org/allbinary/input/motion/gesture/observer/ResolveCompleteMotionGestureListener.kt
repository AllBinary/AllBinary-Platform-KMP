...
open public class ResolveCompleteMotionGestureListener :
    Object, CompleteMotionGestureListenerInterface {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in size - 1 downTo 0) {
            ...
            var association: MotionGestureToMotionGestureActionAssociation =
                commandActionsList!!.objectArray[index]!!
                    as MotionGestureToMotionGestureActionAssociation

            if (association.isMotionGestureArrayEquals(list) == true) {

                var completeMotionGestureInputEvent: GameKeyCompleteMotionGestureInputEvent =
                    association.getCommandAction() as GameKeyCompleteMotionGestureInputEvent

...
open public class TouchButtonResourceAnimationInterfaceFactoryInterfaceFactory :
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var loadingString: String =
            StringMaker().append(this.toString())!!.append(" Loading: ")!!.toString()!!
        ...
        var touchButtonGenericActionResource: TouchButtonResource =
        ...
        var touchButtonTurnLeftResource: TouchButtonResource =
            TouchButtonTurnLeftResource.getInstance()!!

        var touchButtonTurnRightResource: TouchButtonResource =
            TouchButtonTurnRightResource.getInstance()!!

        var touchButtonStrafeLeftResource: TouchButtonResource =
            TouchButtonStrafeLeftResource.getInstance()!!

        var touchButtonStrafeRightResource: TouchButtonResource =
            TouchButtonStrafeRightResource.getInstance()!!

        var touchButtonBlankResourceImage: Image =
            imageCache!!.getWithKey(touchButtonBlankResource!!.RESOURCE)!!

        var touchButtonGenericActionResourceImage: Image =
            imageCache!!.getWithKey(touchButtonGenericActionResource!!.RESOURCE)!!

        var touchButtonStartResourceImage: Image =
            imageCache!!.getWithKey(touchButtonStartResource!!.RESOURCE)!!

        var touchButtonUpResourceImage: Image =
            imageCache!!.getWithKey(touchButtonUpResource!!.RESOURCE)!!

        var touchButtonDownResourceImage: Image =
            imageCache!!.getWithKey(touchButtonDownResource!!.RESOURCE)!!

        var touchButtonTurnLeftResourceImage: Image =
            imageCache!!.getWithKey(touchButtonTurnLeftResource!!.RESOURCE)!!

        var touchButtonTurnRightResourceImage: Image =
            imageCache!!.getWithKey(touchButtonTurnRightResource!!.RESOURCE)!!

        var touchButtonStrafeLeftResourceImage: Image =
            imageCache!!.getWithKey(touchButtonStrafeLeftResource!!.RESOURCE)!!

        var touchButtonStrafeRightResourceImage: Image =
            imageCache!!.getWithKey(touchButtonStrafeRightResource!!.RESOURCE)!!
        ...
        progressCanvas!!.addPortion(portion, loadingString, index++)
        imageCompleteUtil!!.waitForImage(
        ...
        if (OperatingSystemFactory.getInstance()!!.getOperatingSystemInstance()!!.isOverScan()) {
            ...
            var touchButtonStartHintResource: Image =
                imageCache!!.getWithKey(TouchButtonStartResource.getInstance()!!.HINT)!!

            this.add(
                touchButtonStartResource!!.HINT,
                OneRowSpriteIndexedAnimationFactory.createFactory(

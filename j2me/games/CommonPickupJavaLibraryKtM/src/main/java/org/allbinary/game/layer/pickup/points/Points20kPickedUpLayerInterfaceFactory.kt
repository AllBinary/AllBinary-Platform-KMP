...
open public class Points20kPickedUpLayerInterfaceFactory :
    ...
    companion object {
        ...
        {
            Points20kPickedUpLayerInterfaceFactory.pickedUpLayerInterfaceFactoryInterface =
                Points20kPickedUpLayerInterfaceFactory()
        }
    ...
    private var pool: PointsLayerCircularStaticPool =
        PointsLayerCircularStaticPool(
            PointsLayerFactory(GameConfigurationUtil.getInstance()!!.getCompetitionValue() * 20000),
            1,
        )

    private constructor() :
        super(
            PickedUpLayerTypeFactory.getInstance()!!.POINTS,
            IconLayerFactory.getInstance(
                FeaturedAnimationInterfaceFactoryInterfaceFactory.getInstance()!!.get(
                        PointsResources.getInstance()!!.RESOURCE_2
                    )!!
                    .getInstance(0),
                10,
                10,

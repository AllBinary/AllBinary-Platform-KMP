...
open public class DestroyedEventHandler : BasicEventHandler {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in this.list.size()!! - 1 downTo 0) {
            ...
            try {
                ...
                var collidableDestroyableDamageableLayer: CollidableDestroyableDamageableLayer =
                    this.list.objectArray[index]!! as CollidableDestroyableDamageableLayer
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var destroyedEventListenerInterface: DestroyedEventListenerInterface =
            eventListenerInterface as DestroyedEventListenerInterface

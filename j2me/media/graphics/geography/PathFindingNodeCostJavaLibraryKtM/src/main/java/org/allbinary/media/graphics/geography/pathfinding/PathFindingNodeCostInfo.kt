...
open public class PathFindingNodeCostInfo : Object, Comparable<PathFindingNodeCostInfo> {

    private val pathFindingNodeCostInfoData: PathFindingNodeCostInfoData =
        PathFindingNodeCostInfoData.getInstance()!!
    ...
    public constructor(costFromStart: Long, costToGoal: Long) : super() {

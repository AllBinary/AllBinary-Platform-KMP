...
open public class DropCellPositionHistory : Object {
    ...
    open fun addAll(list: BasicArrayList, layerInterface: AllBinaryLayer)
        // nullable = true from not(false or (false and false)) = true
    {
        // var list = list
        // var layerInterface = layerInterface
    ...
    open fun removeAll(layerInterface: AllBinaryLayer)
        // nullable = true from not(false or (false and false)) = true
    {
        // var layerInterface = layerInterface
    ...
    open fun isCellPositionWithDrop(
    ...
    open fun anyCellPositionWithDrop(
        list: BasicArrayList
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {
    ...
    open fun getCellPositionWithDrop(
        list: BasicArrayList
    )
        // nullable = true from not(false or (false and false)) = true
        : CellPosition {

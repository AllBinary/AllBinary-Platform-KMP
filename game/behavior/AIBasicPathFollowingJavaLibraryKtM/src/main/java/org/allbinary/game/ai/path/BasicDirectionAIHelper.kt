...
open public class BasicDirectionAIHelper : Object {

    private var name: String

    private var angleInfo: AngleInfo

    public constructor(name: String, angleInfo: AngleInfo) : super() {
        // var name = name
    ...
    open fun getAIKeyPressed(
        ...
        var angle: Short =
            this.angleInfo!!.getAngleIncrementInfo()!!.getFrameAngle(frame.toInt()).toShort()
    ...
    open fun getAIKeyPressedFromDirection(
        geographicMapDirectionData: Direction
    )
        // nullable = true from not(false or (false and false)) = true
        : Int {

...
open public class WaypointEventHandlerFactory : Object {

    companion object {

        private val eventHandlerArray: Array<WaypointEventHandler?> =
            arrayOf(
        ...
        open fun getInstance(
            ...
            return WaypointEventHandlerFactory.eventHandlerArray[
                    groupInterface!!.getGroupId().toInt()]!!
        }

...
open public class SpecialDemoGameMidlet : DemoGameMidlet {
    ...
    public constructor(
        ...
        licenseLoadingType: LicenseLoadingType,
        demoSetupFactory: LicensedDemoSetupFactory,
        licenseCheckRunnableFactory: LicenseCheckRunnableFactory,
    ...
    override fun preInit()
        // nullable = true from not(false or (false and true)) = true
    {
        LicenseServerInitFileUtil().init()
    }
}

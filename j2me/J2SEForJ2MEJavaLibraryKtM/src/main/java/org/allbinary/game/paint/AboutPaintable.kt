...
// J2SEForJ2ME
open public class AboutPaintable : Paintable, UpdateMyFontInterface {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        graphics.drawString(
            this.ABOUT,
            halfWidth - this.aboutBeginWidth,
            2 * this.charHeight,
            this.anchor,
        )
        ...
        for (index in 0 until infoSize) {
            ...
            graphics.drawString(
                this.info[index]!!,
                halfWidth - this.infoBeginWidth[index],
                (4 + index) * this.charHeight,
                this.anchor,
            )
        }
        ...
        for (index in 0 until size) {
            ...
            graphics.drawString(
                ...
                halfWidth - this.developersBeginWidth[index],
                (5 + infoSize + index) * this.charHeight,
                this.anchor,
            )
        }
    }

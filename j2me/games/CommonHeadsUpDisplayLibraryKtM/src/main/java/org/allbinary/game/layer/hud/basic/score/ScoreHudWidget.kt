...
companion object {
    ...
    open fun getInstance(maxscore: Int, location: Int, direction: Int)
...
: ScoreHudWidget{
    ...
    //var direction = direction
                        ...
                        return ScoreHudWidget(maxscore, location, direction, 2, BasicColorFactory.getInstance()!!.GREY)
}


        }
            public constructor (maxscore: Int, location: Int, direction: Int, bufferZone: Int, basicColor: BasicColor)                        

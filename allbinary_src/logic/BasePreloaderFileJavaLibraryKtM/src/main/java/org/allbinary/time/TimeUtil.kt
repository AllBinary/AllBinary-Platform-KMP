...
open public class TimeUtil : Object {
    ...
    open fun setExpirationCalendar(
        calendar: Calendar,
        yearsString: String,
        monthsString: String,
        daysString: String,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var year: Int = calendar.get(Calendar.YEAR) + Integer(yearsString).toInt()

        var month: Int = calendar.get(Calendar.MONTH) + Integer(monthsString).toInt()

        var day: Int = calendar.get(Calendar.DAY_OF_MONTH) + Integer(daysString).toInt()

        var hour: Int = calendar.get(Calendar.HOUR) + Integer(hoursString).toInt()

        var minute: Int = calendar.get(Calendar.MINUTE) + Integer(minutesString).toInt()

        var second: Int = calendar.get(Calendar.SECOND) + Integer(secondsString).toInt()

        calendar.set(year, month, day, hour, minute, second)
    }

    open fun getTotalTime(
        yearString: String,
        monthString: String,
        dayString: String,
        hourString: String,

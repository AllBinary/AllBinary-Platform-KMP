...
open public class CanvasDrawLineString : Object, UpdateMyFontInterface {
    ...
    public constructor(x: Int, y: Int) : super() {
        var x = x
        var y = y
        this.x = x
        this.y = y
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.drawStringUtil!!.drawCenterString(
            graphics,
            string,
            0,
            string.length,
            this.x,
            this.y + (line * this.fontHeight),
        )
    }
}

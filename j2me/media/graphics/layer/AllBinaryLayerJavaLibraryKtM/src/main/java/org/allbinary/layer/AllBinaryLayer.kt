...
open public class AllBinaryLayer : Layer, LayerInterface {

    companion object {

        val NULL_ALLBINARY_LAYER: AllBinaryLayer =
            AllBinaryLayer(
        ...
        if (name == null) {
            ...
            localName =
                StringMaker()
                    ...
                    .append(Integer.toHexString(TsUtil.getInstance()!!.hashCode(this)))!!
                    .toString()
        }

...
open public class LeftOrientationInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                LeftOrientationInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                LeftOrientationInputToGameKeyEventAction.instance =
                    LeftOrientationInputToGameKeyEventAction()
            }
    ...
    private constructor() :
        super(
            "Left Action",
            OrientationMotionGestureFactory.getInstance()!!.LEFT,

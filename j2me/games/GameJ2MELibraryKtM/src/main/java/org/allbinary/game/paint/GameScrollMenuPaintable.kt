...
open public class GameScrollMenuPaintable : BasicGameDemoPaintable, ColorChangeListener {

    public constructor(
        mainDemoStatePaintable: Paintable,
        ownershipPaintable: Paintable,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var formPaintable: FormPaintable =
            mainGameDemoStatePaintable!!.getMenuPaintableInterface() as FormPaintable

        var scrollSelectionForm: ScrollSelectionForm =
            formPaintable!!.getForm() as ScrollSelectionForm

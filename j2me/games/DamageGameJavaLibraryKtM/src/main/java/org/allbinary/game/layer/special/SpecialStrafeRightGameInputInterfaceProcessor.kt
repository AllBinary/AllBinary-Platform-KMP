...
open public class SpecialStrafeRightGameInputInterfaceProcessor :
    SpecialGameInputInterfaceProcessor {

    public constructor(
        collidableDestroyableDamageableLayer: SpecialGameInputInterface

...
open public class PreGameLockablePaintable : LockablePaintable {
    ...
    public constructor(
        paintableForm: ScrollCurrentSelectionForm,
        lockedIndex: Int,
    ) : super(lockedIndex) {
        ...
        this.halfWidth =
            GameFeatureImageCacheFactory.getInstance()!!.getWithKey(
                    LockedResources.getInstance()!!.LOCKED_DEMO_GAME_FEATURE_RESOURCE
                )!!
                .getWidth() / 2
    }

...
open public class GameConfigurationUtil : Object {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var gameConfigurationSingleton: GameConfigurationSingleton =
            GameConfigurationSingleton.getInstance()!!

        var gameConfiguration: GameConfiguration =
            gameConfigurationSingleton!!.getInstanceByName(gauge.getLabel())!!
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var value: Integer =
            smallIntegerSingletonFactory!!.getAt(
                gauge.getValue() + gameConfiguration!!.getMinValue()!!.toInt()
            )!!
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        gauge.setValue(
            gameConfiguration!!.getDefaultValue()!!.toInt() -
                gameConfiguration!!.getMinValue()!!.toInt()
        )
        gameConfiguration!!.setValue(gameConfiguration!!.getDefaultValue())
    }

    @Throws(Exception::class)
    open fun updateChallange(
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (gameConfiguration == gameConfigurationCentral!!.CHALLENGE_LEVEL) {
            ...
            gameConfigurationCentral!!.ATTACK_CHALLENGE_LEVEL.setValue(
                gameConfiguration!!.getValue()
            )
            gameConfigurationCentral!!.DURABILITY_CHALLENGE_LEVEL.setValue(
                gameConfiguration!!.getValue()
            )
            gameConfigurationCentral!!.SPEED_CHALLENGE_LEVEL.setValue(
                gameConfiguration!!.getValue()
            )
            ...
            for (index in 0 until size) {
                ...
                if (item is GameConfigurationGauge) {
                    ...
                    var nextGameConfiguration: GameConfiguration =
                        gameConfigurationSingleton!!.getInstanceByName(name)!!

                    if (nextGameConfiguration == gameConfigurationCentral!!.COLLIDE_DAMAGE) {

                        gauge.setValue(
                            gameConfigurationCentral!!.COLLIDE_DAMAGE.getValue()!!.toInt() -
                                gameConfiguration!!.getMinValue()!!.toInt()
                        )
                    } else if (
                        nextGameConfiguration ==
                            gameConfigurationCentral!!.DURABILITY_CHALLENGE_LEVEL
                    ) {
                        gauge.setValue(
                            gameConfigurationCentral!!.DURABILITY_CHALLENGE_LEVEL.getValue()!!
                                .toInt() - gameConfiguration!!.getMinValue()!!.toInt()
                        )
                    } else if (
                        nextGameConfiguration == gameConfigurationCentral!!.ATTACK_CHALLENGE_LEVEL
                    ) {
                        gauge.setValue(
                            gameConfigurationCentral!!.ATTACK_CHALLENGE_LEVEL.getValue()!!.toInt() -
                                gameConfiguration!!.getMinValue()!!.toInt()
                        )
                    } else if (
                        nextGameConfiguration == gameConfigurationCentral!!.SPEED_CHALLENGE_LEVEL
                    ) {
                        gauge.setValue(
                            gameConfigurationCentral!!.SPEED_CHALLENGE_LEVEL.getValue()!!.toInt() -
                                gameConfiguration!!.getMinValue()!!.toInt()
                        )
                    }
                }
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        this.COMPETITION_VALUE =
            gameConfigurationCentral!!.COLLIDE_DAMAGE.getValue()!!.toInt() +
                gameConfigurationCentral!!.ATTACK_CHALLENGE_LEVEL.getValue()!!.toInt() +
                gameConfigurationCentral!!.DURABILITY_CHALLENGE_LEVEL.getValue()!!.toInt() +
                gameConfigurationCentral!!.SPEED_CHALLENGE_LEVEL.getValue()!!.toInt()

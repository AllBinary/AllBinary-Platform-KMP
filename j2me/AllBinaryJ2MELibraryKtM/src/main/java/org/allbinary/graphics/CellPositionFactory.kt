...
open public class CellPositionFactory : Object {
    ...
    private var cellPositionArray: Array<Array<CellPosition?>?> =
        Array(0) { arrayOfNulls<CellPosition?>(0) }

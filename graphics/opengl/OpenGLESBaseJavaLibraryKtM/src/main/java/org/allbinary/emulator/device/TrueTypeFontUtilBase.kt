...
open public class TrueTypeFontUtilBase : Object {

    val shortPattern: String

    private val patternAsBytes: ByteArray =
        byteArrayOf(
            32,
            48,
            49,
    ...
    public constructor(scale: Int) : super() {
        // var scale = scale
        ...
        if (AvianUtil.isAvian()) {
            ...
            var shortPatterAsByteArray: ByteArray =
                byteArrayOf(
                    32,
                    48,
                    49,

...
open public class SpecialAnimation : IndexedAnimation, SpecialAnimationInterface {

    companion object {

        private val NULL_SPECIAL_ANIMATION: SpecialAnimation =
            SpecialAnimation(IndexedAnimationBehavior(1, 250))
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        var indexedAnimationBehavior: IndexedAnimationBehavior =
            (this.animationBehaviorP as IndexedAnimationBehavior)

...
open public class MineCountedPickedUpLayerInterfaceFactory : CountedPickedUpLayerInterfaceFactory {
    ...
    companion object {
        ...
        {
            MineCountedPickedUpLayerInterfaceFactory.pickedUpLayerInterfaceFactoryInterface =
                MineCountedPickedUpLayerInterfaceFactory()
        }
    ...
    private val weaponProperties: WeaponProperties =
        WeaponProperties(-1L, -1L, 0, 8000, 10.toShort())

    private val smallIntegerSingletonFactory: SmallIntegerSingletonFactory =
        SmallIntegerSingletonFactory.getInstance()!!

    @Throws(Exception::class)
    override fun getNextInstance(
        ...
        var sourceLayerInterface: AllBinaryLayer =
            hashtable.get(this.smallIntegerSingletonFactory!!.getAt(0) as Object) as AllBinaryLayer

        var angle: Integer =
            hashtable.get(this.smallIntegerSingletonFactory!!.getAt(1) as Object) as Integer

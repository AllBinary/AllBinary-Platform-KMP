...
open public class VisibleCellPositionsSingleton :
    Object, BuildingEventListenerInterface, ScrollMapEventListenerInterface {
    ...
    private var stationaryVisibleCellPositions: Array<ShortArray?> =
        NullUtil.getInstance()!!.NULL_SHORT_ARRAY_ARRAY

    private var visibleCellPositions: Array<ShortArray?> =
        NullUtil.getInstance()!!.NULL_SHORT_ARRAY_ARRAY

    private var currentlyVisibleCellPositions: Array<ShortArray?> =
        NullUtil.getInstance()!!.NULL_SHORT_ARRAY_ARRAY
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in list.size() - 1 downTo 0) {
            ...
            this.stationaryVisibleCellPositions[cellPosition!!.getRow()]!![

...
open public class StartCanvas :
    RunnableCanvas, GameCanvasRunnableInterface, MenuListener, DisplayChangeEventListener {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        try {
            ...
            if (
                this.features.isDefault(this.openGLFeatureFactory!!.OPENGL_AS_GAME_THREAD) ||
                    J2MEUtil.isHTML()
            ) {} else {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        try {
            ...
            if (
                (this.features.isDefault(this.openGLFeatureFactory!!.OPENGL) ||
                    J2MEUtil.isHTML()) && !running
            ) {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        this.baseGameStatistics!!.add(
            StringMaker()
                .append(StartCanvas.BOT_GAME_STATS)!!

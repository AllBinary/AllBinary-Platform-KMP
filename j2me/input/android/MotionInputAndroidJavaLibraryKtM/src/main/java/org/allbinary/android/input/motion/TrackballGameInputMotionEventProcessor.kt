...
open public class TrackballGameInputMotionEventProcessor : MotionEventProcessor {
    ...
    companion object {
        ...
        private var PROCESSOR: TrackballGameInputMotionEventProcessor =
    ...
    private val listener: SingleKeyPressGameKeyFromMotionGestureEventListener =
        SingleKeyPressGameKeyFromMotionGestureEventListener()

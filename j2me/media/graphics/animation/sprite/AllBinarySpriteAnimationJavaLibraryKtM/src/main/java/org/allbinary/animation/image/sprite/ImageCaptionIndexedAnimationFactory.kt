...
open public class ImageCaptionIndexedAnimationFactory : Object, AnimationInterfaceFactoryInterface {

    val animationFactoryImageScaleUtil: AnimationFactoryImageScaleUtil =
        AnimationFactoryImageScaleUtil.getInstance()!!

    private val animationFactorySpriteScaleUtil: AnimationFactorySpriteScaleUtil =
        AnimationFactorySpriteScaleUtil.getInstance()!!
    ...
    override fun getInstance(
        ...
        var scaledImage: Image =
            this.animationFactoryImageScaleUtil!!.createImage(
                this.captionImage,
                this.captionImage!!.getWidth(),
                this.captionImage!!.getHeight(),
                this.scaleProperties!!.scaleWidth,
                this.scaleProperties!!.scaleHeight,
            )!!

        var animationInterface: Animation =
            ImageAnimation(scaledImage, this.animationBehaviorFactory!!.getOrCreateInstance())

        var sprite: Sprite =
            this.animationFactorySpriteScaleUtil!!.createImage(
                this.spriteMovieImage,
                this.frameWidth,
                this.frameHeight,
                this.scaleProperties!!.scaleWidth,
                this.scaleProperties!!.scaleHeight,
        ...
        var movieIndexedAnimationInterface: IndexedAnimation =
            SpriteIndexedAnimation(
                sprite,
                this.spriteMovieImage,
                BasicColorUtil.getInstance()!!.ZERO_ARRAY,
        ...
        return CaptionIndexedAnimation(
            animationInterface,
            movieIndexedAnimationInterface,
            player,
            this.captionDx,
            this.captionDy,
            this.dx,

...
open public class StringValidationUtil : Object {
    ...
    open fun isValidRequiredNumber(
        value: String,
        min: Int,
        max: Int,
    )
    ...
    open fun isValidNotRequiredNumber(
        value: String,
        min: Int,
        max: Int,
    )
        ...
        if (value != null) {
            ...
            if (
                this.tsUtil!!.compareTo(value, this.stringUtil!!.NULL_STRING) == 0 ||
                    value.length < min ||
                    value.length > max
            ) {

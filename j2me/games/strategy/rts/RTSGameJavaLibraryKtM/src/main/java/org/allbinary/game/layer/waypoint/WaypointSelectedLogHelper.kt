...
open public class WaypointSelectedLogHelper : WaypointLogHelper {
    ...
    companion object {
        ...
        private val instanceC: WaypointSelectedLogHelper = WaypointSelectedLogHelper()
    ...
    override fun addWaypointFromBuilding(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        advancedRTSGameLayer: PathFindingLayerInterface,
    )
        // nullable = true from not(false or (false and false)) = true
    ...
    override fun addWaypointFromBuildingList(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        advancedRTSGameLayer: PathFindingLayerInterface,
        list: BasicArrayList,
    )
    ...
    override fun insertWaypointList(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        index: Int,
        rtsLayer: CollidableDestroyableDamageableLayer,
        waypointName: String,
    ...
    override fun setRandomGeographicMapCellHistoryList(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            ...
            this,
            "selected: setRandomGeographicMapCellHistory",
        )
    }
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                ...
                .append(" Trying to move away from building")!!
                .toString(),
            this,
            "selected: moveAwayFromBuilding",
        )
    }

    override fun needToMove(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        unitWaypointBehavior: WaypointBehaviorBase,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        // var associatedAdvancedRTSGameLayer = associatedAdvancedRTSGameLayer
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append(associatedAdvancedRTSGameLayer!!.getName())!!
                .append(unitWaypointBehavior!!.getMovementLogicAsString())!!
                .toString(),
            this,
            "needToMove",
        )
    ...
    override fun setRandomGeographicMapCellHistory(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface
    )
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append(associatedAdvancedRTSGameLayer!!.getName())!!
                .append(" pathsList is null")!!
                .toString(),
            this,
            "setRandomGeographicMapCellHistory",
        )
    }

    override fun setCurrentPathGeographicMapCellPosition(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        existingCurrentPathGeographicMapCellPosition: GeographicMapCellPosition,
        currentPathGeographicMapCellPosition: GeographicMapCellPosition,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        // var associatedAdvancedRTSGameLayer = associatedAdvancedRTSGameLayer
        // var existingCurrentPathGeographicMapCellPosition =
        // existingCurrentPathGeographicMapCellPosition
        // var currentPathGeographicMapCellPosition = currentPathGeographicMapCellPosition

        if (existingCurrentPathGeographicMapCellPosition == null)
            this.logUtil!!.putF(
                StringMaker()
                    .append(associatedAdvancedRTSGameLayer!!.getName())!!
                    .append(" currentPathGeographicMapCellPosition: ")!!
                    .append(this.stringUtil!!.toString(currentPathGeographicMapCellPosition))!!
                    .toString(),
                this,
                "setCurrentPathGeographicMapCellPosition",
            )
    }

    override fun setNextUnvisitedPathGeographicMapCellPosition(
        associatedAdvancedRTSGameLayer: PathFindingLayerInterface,
        existingNextUnvisitedPathGeographicMapCellPosition: GeographicMapCellPosition,
        nextUnvisitedPathGeographicMapCellPosition: GeographicMapCellPosition,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        // var associatedAdvancedRTSGameLayer = associatedAdvancedRTSGameLayer
        // var existingNextUnvisitedPathGeographicMapCellPosition =
        // existingNextUnvisitedPathGeographicMapCellPosition
        ...
        if (
            ...
            this.logUtil!!.putF(
                StringMaker()
                    ...
                    .append(
                        this.stringUtil!!.toString(nextUnvisitedPathGeographicMapCellPosition)
                    )!!
                    .toString(),
                this,
                "setNextUnvisitedPathGeographicMapCellPosition",
            )
    }
}

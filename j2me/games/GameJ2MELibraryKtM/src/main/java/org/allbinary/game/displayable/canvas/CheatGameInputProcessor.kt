...
open public class CheatGameInputProcessor : PlayerGameInput {
    ...
    companion object {
        ...
        var inputProcessor: SpecialGameInputInterface =
            SpecialGameInputFactory.NO_SPECIAL_GAME_INPUT
    }
        ...
        try {
            ...
            for (index in 0 until size) {
                ...
                if (key == this.gameKeyFactory!!.LEFT.getId()) {
                    ...
                    CheatGameInputProcessor.inputProcessor!!.special1(
                        gameLayerManager,
                        GameKeyEvent.NONE,
                    )
                    break
                    ...
                    CheatGameInputProcessor.inputProcessor!!.special2(
                        gameLayerManager,
                        GameKeyEvent.NONE,
                    )
                    break

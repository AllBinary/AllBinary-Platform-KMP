...
open public class GeologicalGeographicMapCellPositionFactory :
    Object, GeographicMapCellPositionFactoryInterface {

    private val resourcePerMapCellType: IntArray

    public constructor(resourcePerMapCellType: IntArray) : super() {
    ...
    override fun getInstance(
        ...
        return GeologicalGeographicMapCellPosition(
            i_column,
            i_row,
            columns,
            rows,

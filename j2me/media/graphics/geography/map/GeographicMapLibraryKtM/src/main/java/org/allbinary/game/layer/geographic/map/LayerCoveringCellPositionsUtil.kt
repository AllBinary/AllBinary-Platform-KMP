...
open public class LayerCoveringCellPositionsUtil : Object {
    ...
    open fun getAll(
        geographicMapInterface: BasicGeographicMap,
        topLeftGeographicMapCellPosition: GeographicMapCellPosition,
        layerInterface: AllBinaryLayer,
        reusableList: BasicArrayList,
    )
        // nullable = true from not(false or (false and false)) = true

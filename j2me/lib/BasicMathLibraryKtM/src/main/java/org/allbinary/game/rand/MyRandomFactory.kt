...
open public class MyRandomFactory : Object {
    ...
    companion object {
            ...
            // nullable = true from not(false or (false and false)) = true
        {
            ...
            for (index in 0 until size2) {
                ...
                stringBuilder!!
                    .appendint(randomFactory!!.getAbsoluteNextInt(3))!!
            ...
            for (index in 0 until size) {
                ...
                if (!found) throw RuntimeException()
            }
        }
    }
    ...
    open fun getAbsoluteNextIntAllowZero(
        range: Int
    )
        // nullable = true from not(false or (false and false)) = true
        : Int {

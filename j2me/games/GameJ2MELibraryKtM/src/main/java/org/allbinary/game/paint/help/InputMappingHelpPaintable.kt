...
open public class InputMappingHelpPaintable : HelpPaintable {
    ...
    private var inputBasicColorArray: Array<Array<BasicColor?>?> =
        Array(0) { arrayOfNulls<BasicColor?>(0) }

    private var selectedBasicColor: BasicColor

    open public inner class UpdateMyFontProperties : Object {
    ...
    protected constructor(
        ...
        if (
            backgroundBasicColor == this.basicColorFactory!!.WHITE ||
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in 0 until size) {
            ...
            stringMaker!!.delete(0, stringMaker!!.length())
            updateMyFontProperties!!.keymappingBeginWidthArray[index] =
                (font.stringWidth(
                    stringMaker!!
                        .append(updateMyFontProperties!!.actionStringArray[index]!!)!!
                        .append(keyMappings)!!
                        .toString()
                ) shr 1)
            ...
            for (index2 in 0 until size2) {
                ...
                updateMyFontProperties!!.inputDeltaXArray[index]!![index2] =
                    font.stringWidth(input.getName())
                ...
                if (index2 + 1 < list.size()) {
                    ...
                    if (list.size() == 2) {
                        ...
                        updateMyFontProperties!!.sepArray[index]!![index2] =
                            InputMappingHelpPaintable.AND
                    } else {

                        if (index2 + 2 == list.size()) {

                            updateMyFontProperties!!.sepArray[index]!![index2] =
                                InputMappingHelpPaintable.MORE_THAN_TWO_IN_LIST_AND
                        } else {
                            updateMyFontProperties!!.sepArray[index]!![index2] =
                ...
                if (updateMyFontProperties!!.sepArray[index]!![index2] != EMPTY_STRING) {
                    ...
                    updateMyFontProperties!!.sepWidthArray[index]!![index2] =
                        font.stringWidth(updateMyFontProperties!!.sepArray[index]!![index2]!!)
                }
            }
        }
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            stringMaker!!
                ...
                .append(this.stringUtil!!.toString(selectedGameKey))!!
                .append(" Input: ")!!
                .append(this.stringUtil!!.toString(selectedInput))!!
                .toString(),
            this,
        ...
        var inputBasicColorArray: Array<Array<BasicColor?>?> =
            arrayOfNulls<Array<BasicColor?>>(size)
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        graphics.drawString(
            ...
            this.updateMyFontProperties!!.charHeight,
            this.anchor,
        )

...
open public class TerrainEventHandler : BasicEventHandler {
    ...
    companion object {
        ...
        private var hashtable: ABHashtable<Any, Any> = StdUtil.getInstance()!!.NULL_TABLE
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in this.list.size()!! - 1 downTo 0) {
            ...
            try {
                ...
                var terrainEventListener: TerrainEventListener =
                    this.list.get(index) as TerrainEventListener
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var terrainEventListenerInterface: TerrainEventListenerInterface =
            eventListenerInterface as TerrainEventListenerInterface

...
open public class NoDecimalTrigTable
            : Object
         {
...
noDecimalSin= LongArray(TOTAL_ANGLE)
noDecimalCos= LongArray(TOTAL_ANGLE)
noDecimalTan= LongArray(TOTAL_ANGLE +1)
noDecimalSin[0]= 0
noDecimalSin[1]= 174
noDecimalSin[2]= 348
noDecimalSin[3]= 523
...
: Short{
    ...
    var MIN_VALUE: Long = (Integer.MIN_VALUE.toLong())


    var ratio: Long = (MAX_VALUE -1).toLong()
...
PreLogUtil.put(stringMaker!!.append(
                            "screenX: ")!!.append(screenX)!!.append(
                            " screenY: ")!!.append(screenY)!!.append(
                            " targetX: ")!!.append(targetX)!!.append(
                            " targetY: ")!!.append(targetY)!!.toString(), this, METHOD_NAME)

    var targetX2: Int =  -targetX.toInt()


    var targetY2: Int =  -targetY.toInt()


    var screenX2: Int =  -screenX.toInt()


    var screenY2: Int =  -screenY.toInt()


    var dx: IntArray = IntArray(4)

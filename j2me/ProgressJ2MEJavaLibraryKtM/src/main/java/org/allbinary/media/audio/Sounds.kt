...
open public class Sounds : Object {
    ...
    public constructor(soundsFactoryInterface: SoundsFactoryInterface) : super() {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        var soundInterfaceArray: Array<Sound?> =
            this.soundsFactoryInterface!!.getSoundInterfaceArray()!!
        ...
        for (i in 0 until soundInterfaceArray!!.size) {
            ...
            if (soundInterface != null) {
                ...
                soundInterface!!.init()
                progressCanvas!!.addNormalPortion(
                    100,
                    StringMaker()
                        .append(this.soundStrings!!.INIT_SOUND)!!
                        .append(indexString)!!
                        .toString(),
                )
            }

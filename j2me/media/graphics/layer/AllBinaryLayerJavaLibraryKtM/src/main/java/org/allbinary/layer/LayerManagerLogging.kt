...
open public class LayerManagerLogging : LayerManagerLoggingBase {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            this.stringBuilder!!
                .appendint(TsUtil.getInstance()!!.hashCode(this))!!
                .append(this.APPEND_)!!
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.stringBuilder!!
            .append(Integer.toHexString(TsUtil.getInstance()!!.hashCode(layerManager)))!!

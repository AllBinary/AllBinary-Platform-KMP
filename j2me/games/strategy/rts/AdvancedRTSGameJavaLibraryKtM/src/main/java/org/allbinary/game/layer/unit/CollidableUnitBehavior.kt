...
open public class CollidableUnitBehavior : CollidableRTSBehavior {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var rtsLayer: AdvancedRTSGameLayer =
            collidableInterfaceCompositeInterface as AdvancedRTSGameLayer
        ...
        override fun visit(
            ...
            try {
                ...
                if (this.getList()!!.size() > 0) {
                    ...
                    var allbinaryLayer: CollidableCompositeLayer =
    ...
    open fun steer(
        ...
        var angleInfo: AngleInfo =
            ownerUnitLayer!!.getRotationAnimationInterface()!!.getAngleInfoP()!!
        ...
        if (angle < 90 || angle > 270) {
            ...
            ownerUnitLayer!!
                .getGameKeyEventList()!!
                .add(
                    GameKeyEventFactory.getInstance()!!.getInstanceForKey(
                        ownerUnitLayer,
                        Canvas.RIGHT,
                    )
                )
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (rtsLayer!!.getType() == UnitLayer.getStaticType()) {
            ...
            if (
                !this.simpleSteeringVisitor!!
                    .getList()!!
                    .contains(collidableInterfaceCompositeInterface)
            ) {
            ...
            var list: BasicArrayList =
                ownerUnitLayer!!.getUnitWaypointBehavior()!!.getSteeringVisitorList()!!
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var geographicMapCompositeInterface: GeographicMapCompositeInterface =
            ownerUnitLayer!!.allBinaryGameLayerManagerP as GeographicMapCompositeInterface
        ...
        if (
            ownerLayer!!.getXP() < unitLayer!!.getXP() && ownerLayer!!.getX2() > unitLayer!!.getXP()
        ) {
        ...
        if (
            ownerLayer!!.getYP() < unitLayer!!.getYP() && ownerLayer!!.getY2() > unitLayer!!.getYP()
        ) {

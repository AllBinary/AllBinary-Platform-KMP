...
open public class MultipassNoCacheWaypoint : WaypointBase, BuildingEventListenerInterface {
    ...
    @Throws(Exception::class)
    override fun getPathFindingInfo(
    ...
    override fun getPathsList(
        ...
        try {
            ...
            var list: BasicArrayList =
                PathGenerator.getInstance()!!.createN(

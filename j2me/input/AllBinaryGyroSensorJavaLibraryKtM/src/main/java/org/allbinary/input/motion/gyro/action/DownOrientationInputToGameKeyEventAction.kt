...
open public class DownOrientationInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                DownOrientationInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                DownOrientationInputToGameKeyEventAction.instance =
                    DownOrientationInputToGameKeyEventAction()
            }
    ...
    private constructor() :
        super(
            "Down Action",
            OrientationMotionGestureFactory.getInstance()!!.DOWN,

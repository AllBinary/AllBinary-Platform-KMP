...
open public class SelectAdvancedRTSLayerVisitor : Visitor {
    ...
    override fun visit(
        ...
        var selectedLayer: CollidableDestroyableDamageableLayer =
            anyType as CollidableDestroyableDamageableLayer

        if (
            selectedLayer != CollidableDestroyableDamageableLayer.getNullInstance() &&
            ...
            var list: BasicArrayList =
                this.selectedRTSLayersPlayerGameInput!!.getSelectedBasicArrayList()!!

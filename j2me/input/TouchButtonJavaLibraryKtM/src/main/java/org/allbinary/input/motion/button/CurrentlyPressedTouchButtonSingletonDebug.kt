...
open public class CurrentlyPressedTouchButtonSingletonDebug : CurrentlyPressedTouchButtonSingleton {
    ...
    companion object {
        ...
        private val instanceC: CurrentlyPressedTouchButtonSingletonDebug =
    ...
    {
        var append = append
        this.append = StringMaker().append(this.append)!!.append(append)!!.toString()
        this.string = StringMaker().append(this.listString)!!.append(this.append)!!.toString()
    }
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.append =
            StringMaker()
                .append(GPoint.toStringStatic(x, y, 0))!!

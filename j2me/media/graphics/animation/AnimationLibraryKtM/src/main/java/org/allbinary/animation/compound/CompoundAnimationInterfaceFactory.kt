...
open public class CompoundAnimationInterfaceFactory : Object, AnimationInterfaceFactoryInterface {
    ...
    public constructor(
        ...
        this.basicAnimationInterfaceFactoryInterfaceArrayP =
            basicAnimationInterfaceFactoryInterfaceArray
    ...
    override fun getInstance(
        ...
        for (index in 0 until size) {
            ...
            animationInterfaceArray[index] =
                this.basicAnimationInterfaceFactoryInterfaceArrayP[index]!!.getInstance(instanceId)
        }
    ...
    open fun createAnimation(
        animationInterfaceArray: Array<Animation?>
    )
        // nullable = true from not(false or (false and false)) = true
        : Animation {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in 0 until size) {
            ...
            this.basicAnimationInterfaceFactoryInterfaceArrayP[index]!!.setInitialScale(
                scaleProperties
            )
        }
    }

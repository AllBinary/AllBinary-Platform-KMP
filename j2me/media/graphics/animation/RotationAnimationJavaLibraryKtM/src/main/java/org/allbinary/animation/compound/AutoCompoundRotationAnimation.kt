...
open public class AutoCompoundRotationAnimation : RotationAnimation, CompoundAnimationInterface {

    private var animationInterfaceArray: Array<RotationAnimation?>

    public constructor(
        animationInterfaceArray: Array<RotationAnimation?>,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        // var y = y
        // var z = z
        this.animationInterfaceArray[this.circularIndexUtil!!.getIndex()]!!.paintThreedXYZ(
            graphics,
            x,
            y,
            z,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.animationInterfaceArray[this.circularIndexUtil!!.getIndex()]!!.setFrameByDirection(
            direction
        )
    }

...
open public class StopAtEdgeAI : BasicAI {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (
            x2 + velocityProperties!!.getVelocityXBasicDecimalP()!!.getScaled() >
                displayInfo!!.getLastWidth()
        ) {
            ownerLayerInterface!!.setPosition(
                displayInfo!!.getLastWidth() - width,
                y,
        ...
        if (
            y2 + velocityProperties!!.getVelocityYBasicDecimalP()!!.getScaled() >
                displayInfo!!.getLastHeight()
        ) {
            ownerLayerInterface!!.setPosition(
                x,
                displayInfo!!.getLastHeight() - height,
                ownerLayerInterface!!.getZP(),
            )

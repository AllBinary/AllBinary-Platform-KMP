...
open public class ClientInformation : Object, AbeClientInformationInterface {

    private var operatingSystemInterface: GenericOperatingSystem =
    ...
    private var licenseServers: BasicArrayList =
    ...
    : Hashtable<Any, Any> {
        ...
        clientInfoHashtable!!.put(
            abeClientInformationData!!.OSARCH,
            genericOperatingSystem!!.getArch(),
        )
        clientInfoHashtable!!.put(
            abeClientInformationData!!.OSVERSION,
    ...
    override fun isLargerOrDifferentServerList(
        list: BasicArrayList
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {

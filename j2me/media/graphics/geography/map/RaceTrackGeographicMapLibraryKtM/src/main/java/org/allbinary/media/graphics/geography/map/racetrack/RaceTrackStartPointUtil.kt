...
open public class RaceTrackStartPointUtil : Object {
    ...
    companion object {
        ...
        open fun get(
            ...
            return PointFactory.getInstance()!!.createXY(
                point.getX(),
                point.getY() +
                    geographicMapInterface!!.getAllBinaryTiledLayer()!!.getHalfCellHeight(),
            )
        }
    }

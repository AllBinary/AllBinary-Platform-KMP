...
open public class BasicTopViewGeographicMapCellTypeFactory : GeographicMapCellTypeFactory {
    ...
    public constructor(tileTypeToTileIdsMap: Hashtable<Any, Any>, maxTileId: Int) {
        ...
        var basicTopViewGeographicMapStrings: BasicTopViewGeographicMapStrings =
        ...
        var BLOCK_CELL_TYPE: BasicTopViewGeographicMapCellType =
            BasicTopViewGeographicMapCellType.createType(
                basicTopViewGeographicMapStrings!!.DEFAULT,
                1,
                1,
            )!!
        ...
        var keyArray: Array<Any?> =
            HashtableUtil.getInstance()!!.getKeysAsArray(tileTypeToTileIdsMap)!!
            ...
            if (key.equals(basicTopViewGeographicMapStrings!!.WALL)) {
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.WALL,
                        idsWithTypeList,
                        1000,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.OFF_MAP,
                        idsWithTypeList,
                        1001,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.FLOOR,
                        idsWithTypeList,
                        1,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.DOOR,
                        idsWithTypeList,
                        1,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.STAIRS_UP,
                        idsWithTypeList,
                        1,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.STAIRS_DOWN,
                        idsWithTypeList,
                        1,
                    )
                ...
                basicPlatormGeographicMapCellType =
                    BasicTopViewGeographicMapCellType(
                        basicTopViewGeographicMapStrings!!.OTHER,
                        idsWithTypeList,
                        1,
                    )
    ...
    : String {
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return StringMaker()
            .append("key: WALL/BLOCK_CELL_TYPE: ")!!
            .append(this.BLOCK_CELL_TYPE.toString())!!
            .append("key: FLOOR_CELL_TYPE: ")!!
            .append(this.FLOOR_CELL_TYPE.toString())!!
            .append("key: OTHER_CELL_TYPE: ")!!
            .append(this.OTHER_CELL_TYPE.toString())!!
            .append("key: OFF_MAP_CELL_TYPE: ")!!
            .append(this.OFF_MAP_CELL_TYPE.toString())!!
            .append("key: DOOR_CELL_TYPE: ")!!
            .append(this.DOOR_CELL_TYPE.toString())!!
            .append("key: STAIRS_DOWN_CELL_TYPE: ")!!
            .append(this.STAIRS_DOWN_CELL_TYPE.toString())!!
            .append("key: STAIRS_UP_CELL_TYPE: ")!!
            .append(this.STAIRS_UP_CELL_TYPE.toString())!!
            .toString()
    }
}

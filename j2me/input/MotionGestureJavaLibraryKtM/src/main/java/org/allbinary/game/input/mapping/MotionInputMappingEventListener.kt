...
open public class MotionInputMappingEventListener : Object, InputMappingEventListenerInterface {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        BasicTouchInputFactory.getInstance()!!.updateAll(
            inputMappingEvent!!.getInputToGameKeyMapping()
        )
    }
}

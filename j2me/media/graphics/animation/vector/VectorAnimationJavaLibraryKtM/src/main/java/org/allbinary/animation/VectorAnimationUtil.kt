...
open public class VectorAnimationUtil : Object {
    ...
    open fun toAnimationArrayFromListOfPointListWithPointsPerFrame(
    ...
    open fun toAnimationArrayFromListOfPointList(
        vector: BasicArrayList
    )
        // nullable = true from not(false or (false and false)) = true
        : Array<Array<IntArray?>?> {
    ...
    open fun toFrameArrayFromPointBasicArrayList(
        list: BasicArrayList
    )
        // nullable = true from not(false or (false and false)) = true
        : Array<IntArray?> {

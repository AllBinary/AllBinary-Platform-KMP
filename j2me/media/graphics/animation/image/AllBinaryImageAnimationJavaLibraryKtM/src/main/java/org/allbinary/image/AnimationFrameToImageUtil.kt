...
open public class AnimationFrameToImageUtil : Object {
    ...
    open fun getInstanceTranslate(
        ...
        var image: Image =
            GameFeatureImageCacheFactory.getInstance()!!.get(
                AnimationFrameToImageUtil.instance::class.toString()!!,
                ((width * 3) shr 1),
                ((height * 3) shr 1),
            )!!

...
open public class ImageArrayRotationAnimationCacheable :
    AdjustedImageArrayRotationAnimation, CacheableInterface {
    ...
    public constructor(
        ...
        (anyType as ImageArrayRotationAnimationInfo).getDy(),
        animationBehavior,
    ) {
        // var anyType = anyType

...
open public class PrimitiveLongSingleton : Object {
    ...
    val NUMBER_CHAR_ARRAYS: Array<CharArray?> =
        arrayOf(
            charArrayOf('0'),
            charArrayOf('1'),
            charArrayOf('2'),
    ...
    val ZERO: CharArray = charArrayOf(this.NUMBER_CHAR_ARRAY[0])

    @Throws(Exception::class)
    open fun getNumberFromChar(
        numberAsChar: Char
    )
        ...
        throw Exception(
            StringMaker()
                .append("numberAsChar was not in array: ")!!
                .appendchar(numberAsChar)!!
                .toString()
        )
    }
}

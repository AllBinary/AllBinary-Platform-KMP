...
open public class ABCustomItem
            : Object
         {
        
companion object {
            
    val NULL_CUSTOM_ITEM: ABCustomItem = ABCustomItem(StringUtil.getInstance()!!.EMPTY_STRING, BasicColorFactory.getInstance()!!.BLACK, BasicColorFactory.getInstance()!!.WHITE)

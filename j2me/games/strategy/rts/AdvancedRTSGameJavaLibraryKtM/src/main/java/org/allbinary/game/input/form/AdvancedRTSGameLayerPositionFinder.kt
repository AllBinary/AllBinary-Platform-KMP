...
open public class AdvancedRTSGameLayerPositionFinder : Object, LayerPositionFinderInterface {

    companion object {

        private val instance: AdvancedRTSGameLayerPositionFinder =
    ...
    override fun getLayerInterface(
        ...
        if (layerInterface == AllBinaryLayer.NULL_ALLBINARY_LAYER) {
            ...
            layerInterface =
                WaypointCellPositionHistory.getInstance()!!.getLayerInterface(

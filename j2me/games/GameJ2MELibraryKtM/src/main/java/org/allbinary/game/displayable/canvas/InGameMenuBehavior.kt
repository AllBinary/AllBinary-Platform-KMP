...
open public class InGameMenuBehavior : BaseMenuBehavior {
    ...
    companion object {
        ...
        private val instanceC: InGameMenuBehavior = InGameMenuBehavior()
    ...
    override fun onDisplayChangeEvent(
        allBinaryGameCanvas: AllBinaryGameCanvas,
        displayChangeEvent: DisplayChangeEvent,
    )

...
open public class ReverseVelocityBoundsVisitor : Object, BoundsVisitorInterface {
    ...
    public constructor(layerInterface: LayerInterface) : super() {
        var layerInterface = layerInterface
        this.layerInterface = layerInterface

        var velocityInterfaceCompositeInterface: VelocityInterfaceCompositeInterface =
            layerInterface as VelocityInterfaceCompositeInterface

...
open public class DiagonalDownLeftTouchInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                DiagonalDownLeftTouchInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                DiagonalDownLeftTouchInputToGameKeyEventAction.instance =
                    DiagonalDownLeftTouchInputToGameKeyEventAction()
            }

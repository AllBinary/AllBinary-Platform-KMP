...
open public class ShaderManager : Object {
    ...
    public constructor(GL_VERTEX_SHADER: Int, GL_FRAGMENT_SHADER: Int) : super() {
    ...
    open fun load(
        gl: GL10,
        resource: String,
        shaderAsStringArray: Array<String?>,
        shaderType: Int,
    )

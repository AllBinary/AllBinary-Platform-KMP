...
open public class ArtificialIntelligenceInterfaceFactoryInterfaceFactory : Object {

    companion object {

        private var SINGLETON: ArtificialIntelligenceInterfaceFactoryInterfaceFactory =
    ...
    open fun getInstanceFromCollection(
        ...
        var artificialIntelligenceInterfaceFactoryInterface:
            ArtificialIntelligenceInterfaceFactoryInterface =
            this.list.objectArray[type - 1]!! as ArtificialIntelligenceInterfaceFactoryInterface

...
open public class PlatformImage : Object {

    // Auto Generated
    public constructor() : super() {}

    open fun getImage(
        graphicsSurface2: Any
    )
    ...
    open fun drawImage(
        ...
        y: Int,
        anchor: Int,
        g2: javax.microedition.lcdui.Graphics,
        g: Any,
    )
        // nullable = true from not(false or (false and false)) = true
    {

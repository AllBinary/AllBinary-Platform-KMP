...
open public class CaptionAnimationHelper : CaptionAnimationHelperBase {
    ...
    private val textAnimation: TextAnimation =
        TextAnimation(StringUtil.getInstance()!!.EMPTY_STRING, AnimationBehavior.getInstance())
    ...
    public constructor(
        ...
        this.captionAnimation =
            CaptionAnimation(captionAnimation, this.textAnimation, captionDx, captionDy, dx, dy)
    }

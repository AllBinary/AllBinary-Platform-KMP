...
this.delayJTextField!!.setText(getDelayBetweenKeys.toString())
this.timeJTextField!!.setText(getTime.toString())
...
open fun setKeyActionJDialog(keyActionJDialog: JDialog)
...
open fun initComponents()
        //nullable = true from not(false or (false and true)) = true
{keyActionJDialog= JDialog()
titleJLabel= JLabel()
addKeyJLabel= JLabel()
keyNameJComboBox= JComboBox()
timeJTextField= JTextField()
holdTimeJLabel= JLabel()
inputAutomationTypeJComboBox= JComboBox()
inputTypeJLabel= JLabel()
delayJTextField= JTextField()
delayBetweenJLabel= JLabel()
testJLabel= JLabel()
textJTextField= JTextField()
pressJRadioButton= JRadioButton()
releaseJRadioButton= JRadioButton()
normalJRadioButton= JRadioButton()
simultaneousJRadioButton= JRadioButton()
sequenceJRadioButton= JRadioButton()
jPanel1= JPanel()
okJButton= JButton()
keyIntegerJComboBox= JComboBox()
keyActionJButton= JButton()
jLabel1= JLabel()
keyActionJDialog!!.setMinimumSize(Dimension(255, 280))
titleJLabel!!.setHorizontalAlignment(javax!!.swing!!.SwingConstants.CENTER)
titleJLabel!!.setText(
                            "Keyboard Input Options")
addKeyJLabel!!.setText(
                            "Add Key:")
keyNameJComboBox!!.addActionListener(object: ActionListener()
                                {
...
releaseJRadioButton!!.setText(
                            "Release")
releaseJRadioButton!!.setBorder(javax!!.swing!!.BorderFactory.createEmptyBorder(0, 0, 0, 0))
releaseJRadioButton!!.setMargin(Insets(0, 0, 0, 0))
releaseJRadioButton!!.addActionListener(object: ActionListener()
                                {
...
normalJRadioButton!!.setText(
                            "Normal")
normalJRadioButton!!.setBorder(javax!!.swing!!.BorderFactory.createEmptyBorder(0, 0, 0, 0))
normalJRadioButton!!.setMargin(Insets(0, 0, 0, 0))
normalJRadioButton!!.addActionListener(object: ActionListener()
                                {
...
simultaneousJRadioButton!!.setText(
                            "Simultaneous")
simultaneousJRadioButton!!.setBorder(javax!!.swing!!.BorderFactory.createEmptyBorder(0, 0, 0, 0))
simultaneousJRadioButton!!.setMargin(Insets(0, 0, 0, 0))
simultaneousJRadioButton!!.addActionListener(object: ActionListener()
                                {
...
sequenceJRadioButton!!.setText(
                            "Sequence")
sequenceJRadioButton!!.setBorder(javax!!.swing!!.BorderFactory.createEmptyBorder(0, 0, 0, 0))
sequenceJRadioButton!!.setMargin(Insets(0, 0, 0, 0))
sequenceJRadioButton!!.addActionListener(object: ActionListener()
                                {
...
keyIntegerJComboBox!!.addActionListener(object: ActionListener()
                                {
...
keyIntegerJComboBoxActionPerformed(evt)
    ...
    var keyActionJDialogLayout: GroupLayout = GroupLayout(keyActionJDialog!!.getContentPane())
...
keyActionJButton!!.setText(
                            "Edit")
keyActionJButton!!.addActionListener(object: ActionListener()
                                {
...
open fun keyIntegerJComboBoxActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun sequenceJRadioButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun simultaneousJRadioButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun keyNameJComboBoxActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun keyActionJButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun normalJRadioButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun releaseJRadioButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
open fun pressJRadioButtonActionPerformed(evt: ActionEvent)
        //nullable = true from not(false or (false and false)) = true
{
...
this.normalJRadioButton!!.setSelected(false)
    ...
    private var addKeyJLabel: JLabel

    private var delayBetweenJLabel: JLabel

    private var delayJTextField: JTextField

    private var holdTimeJLabel: JLabel
    ...
    private var keyActionJButton: JButton

    private var keyActionJDialog: JDialog

    private var keyIntegerJComboBox: JComboBox

    private var keyNameJComboBox: JComboBox

    private var normalJRadioButton: JRadioButton

    private var okJButton: JButton

    private var pressJRadioButton: JRadioButton

    private var releaseJRadioButton: JRadioButton

    private var sequenceJRadioButton: JRadioButton

    private var simultaneousJRadioButton: JRadioButton

    private var testJLabel: JLabel

    private var textJTextField: JTextField

    private var timeJTextField: JTextField

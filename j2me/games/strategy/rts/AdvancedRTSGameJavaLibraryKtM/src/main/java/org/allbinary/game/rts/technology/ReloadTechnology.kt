...
open public class ReloadTechnology : Object, RTSInterface {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        unitTechnologySingletonFactory!!.setReload(
            unitTechnologySingletonFactory!!.getReload() + (this.getLevel() * 10)
        )
    }

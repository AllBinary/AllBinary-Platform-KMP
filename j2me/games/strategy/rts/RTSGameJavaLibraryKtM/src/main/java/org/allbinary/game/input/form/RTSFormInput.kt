...
open public class RTSFormInput : Object {
    ...
    public constructor(groupInterfaceArray: Array<Group?>) : super() {
        ...
        for (index in 0 until size) {
            ...
            this.newUnconstructedRTSLayerInterfaceArray[index] =
                CollidableDestroyableDamageableLayer.getNullInstance()
        }

        this.groupInterfaceArray = groupInterfaceArray
        this.hashtable.put(
            DirectionFactory.getInstance()!!.NAME,
            DirectionFactory.getInstance()!!.DOWN,
        )
    ...
    @Throws(Exception::class)
    open fun processStickyGameSpecific(
        associatedRtsLayer: CollidableDestroyableDamageableLayer,
        rtsPlayerLayerInterface: RTSPlayerLayerInterface,
        layerManager: AllBinaryLayerManager,
        item: ABCustomItem,
    ...
    open fun getInstance(
        ...
        if (layerInterfaceFactoryInterface != null) {
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return layerInterfaceFactoryInterface!!.getNextInstance(
                this.getHashtable(),
                cellPoint!!.getX(),
                cellPoint!!.getY(),
                cellPoint!!.getZ(),
    ...
    open fun setSelectedGeographicCellPosition(
        selectedGeographicCellPosition: GeographicMapCellPosition
    )
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append("Selected GeographicMapCellPosition: ")!!
                .append(selectedGeographicCellPosition!!.toString())!!
                .toString(),
            this,

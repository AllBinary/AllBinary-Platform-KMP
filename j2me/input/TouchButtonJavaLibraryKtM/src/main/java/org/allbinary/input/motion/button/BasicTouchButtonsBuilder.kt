        ...
        try {
            ...
            var UP: TouchButton =
                TouchButton.createButton(
                    BasicTouchInputFactory.getInstance()!!.UP,
            ...
            var DOWN: TouchButton =
                TouchButton.createButton(
                    BasicTouchInputFactory.getInstance()!!.DOWN,
            ...
            var LEFT: TouchButton =
                TouchButton.createButton(
                    BasicTouchInputFactory.getInstance()!!.SPECIAL_BUTTON_FOUR,
            ...
            var RIGHT: TouchButton =
                TouchButton.createButton(
                    BasicTouchInputFactory.getInstance()!!.SPECIAL_BUTTON_THREE,

...
open public class DamageTechnology : Object, RTSInterface {

    private var level: Int = 0

    private var maxLevel: Int

    public constructor(maxLevel: Int) : super() {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        var unitTechnologySingletonFactory: UnitTechnologySingletonFactory =
            UnitTechnologySingletonFactory.getInstance()!!

        unitTechnologySingletonFactory!!.setDamage(
            unitTechnologySingletonFactory!!.getDamage() + (this.getLevel() * 100)
        )
    }

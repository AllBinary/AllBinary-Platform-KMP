...
open public class RelativeRelationship : Object {

    companion object {

        val NULL_RELATIVE_RELATIONSHIP: RelativeRelationship =
    ...
    public constructor(point: GPoint, typesAllowedList: BasicArrayList) : super() {
        var point = point

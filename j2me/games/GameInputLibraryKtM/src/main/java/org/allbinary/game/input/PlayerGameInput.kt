...
open public class PlayerGameInput : GameInput, GameKeyEventListenerInterface {
    ...
    public constructor(
        ...
        removalGameKeyEventList: BasicArrayList,
        playerInputId: Int,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        PreLogUtil.put(
            StringMaker()
                ...
                .append(gameKeyEvent!!.toString())!!
                .toString(),
            this,
            this.gameInputStrings!!.ON_DOWN_GAME_KEY,
        )
    }

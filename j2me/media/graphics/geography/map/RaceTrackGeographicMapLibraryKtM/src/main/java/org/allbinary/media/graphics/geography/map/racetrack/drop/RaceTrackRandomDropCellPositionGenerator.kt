...
open public class RaceTrackRandomDropCellPositionGenerator : RaceTrackDropCellPositionGenerator {
    ...
    companion object {
        ...
        private var SINGLETON: RaceTrackRandomDropCellPositionGenerator =
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var pickedUpLayerInterfaceFactory: PickedUpLayerInterfaceFactoryInterface =
        ...
        var pickupLayer: RaceTrackPickupLayer =
            PickupLayerCircularStaticPool.getInstance()!!.getInstanceXYZ(
                pickedUpLayerInterfaceFactory,
                x,
                y,
                tiledLayer!!.getZP() + 3,

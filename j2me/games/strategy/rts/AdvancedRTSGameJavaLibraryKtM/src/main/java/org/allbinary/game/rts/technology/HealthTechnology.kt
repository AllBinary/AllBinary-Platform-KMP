...
open public class HealthTechnology : Object, RTSInterface {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        unitTechnologySingletonFactory!!.setHealth(
            unitTechnologySingletonFactory!!.getHealth() + (this.getLevel() * 100)
        )
    }

...
open public class LocalPlayerBuildingEventHandler : BasicEventHandler {
    ...
    companion object {
        ...
        private var eventHandler: LocalPlayerBuildingEventHandler =
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var buildingEventListenerInterface: BuildingEventListenerInterface =
            (eventListenerInterface as BuildingEventListenerInterface)

...
open public class IndependentVectorExplosionRotationAnimationFactory :
    Object, ProceduralAnimationInterfaceFactoryInterface {

    private var framePoints: Array<Array<IntArray?>?> =
    ...
    private val vectorExplosionGenerator: VectorExplosionGenerator =
    ...
    override fun getInstanceAnimation(
        ...
        if (animationInterface != null) {
            ...
            var rotationAnimationInterface: IndexedAnimation =
                animationInterface as IndexedAnimation

            frame = rotationAnimationInterface!!.getFrame()
        }

        var points: Array<Array<IntArray?>?> =
            this.vectorExplosionGenerator!!.getInstance(
                this.framePoints[frame]!!,
                6,
                this.vectorExplosionGenerator!!.ROTATION,
            )!!

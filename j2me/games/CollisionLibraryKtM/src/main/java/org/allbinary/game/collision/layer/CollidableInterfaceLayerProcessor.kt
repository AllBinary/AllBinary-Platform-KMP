...
open public class CollidableInterfaceLayerProcessor : LayerProcessor {
    ...
    public constructor() : super(CollidableInterfaceLayerManager()) {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var collidableInterfaceCompositeInterface: CollidableInterfaceCompositeInterface =
            layerInterface as CollidableInterfaceCompositeInterface

        if (
            collidableInterfaceCompositeInterface!!
                .getCollidableInferface()!!
                .isCollidable(collidableInterfaceCompositeInterface as CollidableCompositeLayer)
        ) {

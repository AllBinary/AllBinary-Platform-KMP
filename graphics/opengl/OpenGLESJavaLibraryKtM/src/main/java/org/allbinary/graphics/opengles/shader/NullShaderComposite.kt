...
open public class NullShaderComposite : ShaderComposite {
    ...
    companion object {
        ...
        private val instance: NullShaderComposite =
            object :
                NullShaderComposite(
                    OpenGLCapabilities.getInstance()!!.VERSION_2_0,
                    arrayOf(Shader(), Shader()),
    ...
    public constructor(
        ...
        requiresOpenGLVersion,
        shaderArray,
        compositeShaderUpdater,
        shaderInitializer,
        modelViewProjection,
        colorOpenGLProcessor,
        vertexOpenGLProcessor,
        disableProgramShaderOpenGLProcessor,
    ) {

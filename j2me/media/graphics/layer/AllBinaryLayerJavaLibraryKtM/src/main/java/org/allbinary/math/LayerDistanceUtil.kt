...
open public class LayerDistanceUtil : Object {
    ...
    open fun getDistance(
        ...
        layerInterface2: AllBinaryLayer,
    )
        ...
        var dx: Int =
            (layerInterface!!.getXP() + layerInterface!!.getHalfWidth()) -
                (layerInterface2!!.getXP() + layerInterface2!!.getHalfWidth())

        var dy: Int =
            (layerInterface!!.getYP() + layerInterface!!.getHalfHeight()) -
    ...
    open fun getDistance3D(
        ...
        var dz: Int =
            (layerInterface!!.getZP() + layerInterface!!.getHalfDepth()) -

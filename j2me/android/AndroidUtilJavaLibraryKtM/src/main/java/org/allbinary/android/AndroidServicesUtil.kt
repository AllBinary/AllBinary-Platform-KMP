...
open public class AndroidServicesUtil : Object {
    ...
    open fun isServiceRunning(
        ...
        var activityManager: ActivityManager =
            this.resourceUtil!!.getContext()!!.getSystemService(Context.ACTIVITY_SERVICE)
                as ActivityManager

        var runningServicesList: List<RunningServiceInfo> =
            activityManager!!.getRunningServices(this.SERVICE_LIMIT_MAX)!!

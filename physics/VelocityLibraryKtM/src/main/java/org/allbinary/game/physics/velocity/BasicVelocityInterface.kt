...
interface BasicVelocityInterface {
    ...
    open fun setVelocityWithBigDecimalAndDirection(
    ...
    open fun addVelocityWithBigDecimalAndDirection(
        magnitudeBasicDecimal: BasicDecimal,
        direction: Direction,
        otherDirection: Direction,
    )
    ...
    open fun setVelocityWithDirection(
        magnitude: Long,
        direction: Direction,
        otherDirection: Direction,
    )
    ...
    open fun addVelocityWithDirection(
        magnitude: Long,
        direction: Direction,
        otherDirection: Direction,
    )
    ...
    open fun setVelocityWithBigDecimal(
        magnitudeBasicDecimal: BasicDecimal,
        angle: Angle,
        otherAngle: Angle,
    )
    ...
    open fun addVelocityWithBigDecimal(
        magnitudeBasicDecimal: BasicDecimal,
        angle: Angle,
        otherAngle: Angle,
    )

...
open public class DestroyedLayerProcessor : BasicLayerProcessor {
    ...
    companion object {
        ...
        private var DESTROYED_LAYER_PROCESSOR: BasicLayerProcessor =
            BasicLayerProcessor.NULL_LAYER_PROCESSOR
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var destroyEventCircularStaticPool: DestroyEventCircularStaticPool =

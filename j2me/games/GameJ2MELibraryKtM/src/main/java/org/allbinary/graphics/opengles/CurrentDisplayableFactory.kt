...
PreLogUtil.put(StringMaker().
                            append(this.RUNNABLE)!!.append(this.stringUtil!!.toString(this.runnable))!!.append(CommonSeps.getInstance()!!.COLON_SEP)!!.append(this.stringUtil!!.toString(usedRunnable))!!.toString(), this, this.SET_USED_RUNNABLE)

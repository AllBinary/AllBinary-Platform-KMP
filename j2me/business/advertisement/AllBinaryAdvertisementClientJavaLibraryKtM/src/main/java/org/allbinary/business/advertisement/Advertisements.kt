...
open public class Advertisements : Object {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        for (index in this.pageList!!.size()!! - 1 downTo 0) {
            ...
            var advertisementProcessorInterface: AdvertisementProcessorInterface =
                this.pageList!!.objectArray[index]!! as AdvertisementProcessorInterface
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        for (index in this.bannerList!!.size()!! - 1 downTo 0) {
            ...
            var advertisementProcessorInterface: AdvertisementProcessorInterface =
                this.bannerList!!.objectArray[index]!! as AdvertisementProcessorInterface

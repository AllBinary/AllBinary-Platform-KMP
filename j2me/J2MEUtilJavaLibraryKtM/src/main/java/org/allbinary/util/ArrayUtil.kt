...
open public class ArrayUtil : Object {
    ...
    open fun copyOfchar(
        ...
        var copy: CharArray = CharArray(newLength)
    ...
    open fun toStringFromTwoDimensionaArray(
        twoDimensionalIntArray: Array<IntArray?>
    )
        // nullable = true from not(false or (false and false)) = true
        : String {
    ...
    open fun toStringFromObjectArray(
    ...
    open fun toStringFromByteArray(
        byteArray: ByteArray
    )
        // nullable = true from not(false or (false and false)) = true
        : String {

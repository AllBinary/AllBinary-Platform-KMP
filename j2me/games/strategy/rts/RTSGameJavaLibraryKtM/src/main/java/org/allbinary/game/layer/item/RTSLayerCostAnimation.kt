...
open public class RTSLayerCostAnimation :
    Animation, TechEventListenerInterface, UpdateMyFontInterface {
    ...
    public constructor(
        image: Image,
        layerInterfaceFactoryInterface: CostLayerInterfaceFactoryInterface,
    ) {
        var image = image
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        this.len = 0
        this.costString =
            this.primitiveLongUtil!!.getCharArray(this.layerInterfaceFactoryInterface!!.getCost())

...
open public class BufferedGameCanvasPaintHelper : ProcessPaintable {
    ...
    private val offScreenImage: Array<Image?> =
        arrayOfNulls(BufferedGameCanvasPaintHelper.MAX_IMAGES)
    ...
    private val drawCircularIndexUtil: CircularIndexUtil =
        CircularIndexUtil.createInstanceAt(
            BufferedGameCanvasPaintHelper.MAX_IMAGES - 1,
            BufferedGameCanvasPaintHelper.MAX_IMAGES,
        )!!

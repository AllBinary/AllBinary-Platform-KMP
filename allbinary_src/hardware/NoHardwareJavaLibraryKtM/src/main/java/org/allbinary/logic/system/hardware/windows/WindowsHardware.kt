...
open public class WindowsHardware : Object, HardwareInterface {

    public constructor() : super() {}

    open fun getMultimedia(
        index: Int
    )
    ...
    open fun getHardDriveController(
        index: Int
    )
        // nullable = true from not(false or (false and false)) = true
    ...
    open fun getMachineAccessControlAddress(
        index: Int
    )
        // nullable = true from not(false or (false and false)) = true

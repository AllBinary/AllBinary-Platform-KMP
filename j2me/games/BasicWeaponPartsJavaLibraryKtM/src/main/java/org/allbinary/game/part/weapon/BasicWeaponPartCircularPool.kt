...
open public class BasicWeaponPartCircularPool : Object {

    companion object {

        val NULL_BASIC_WEAPON_PART_CIRCULAR_POOL: BasicWeaponPartCircularPool =
            BasicWeaponPartCircularPool()
    }

...
open public class ScrollMapPlayerGameInput : PlayerGameInput {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var terrainTiledLayer: AllBinaryTiledLayer =
    ...
    : Int {
        ...
        if (terrainTiledLayer!!.getHeight() > displayInfo!!.getLastHeight()) {
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return displayInfo!!.getLastHeight() - terrainTiledLayer!!.getHeight() +
    ...
    : Int {
        ...
        if (terrainTiledLayer!!.getWidth() > displayInfo!!.getLastWidth()) {
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return displayInfo!!.getLastWidth() - terrainTiledLayer!!.getWidth() +
                terrainTiledLayer!!.getCellWidth()
        }
    }

    open fun keepOnMapMaxY(
        newY: Int
    )
        // nullable = true from not(false or (false and false)) = true
        : Boolean {

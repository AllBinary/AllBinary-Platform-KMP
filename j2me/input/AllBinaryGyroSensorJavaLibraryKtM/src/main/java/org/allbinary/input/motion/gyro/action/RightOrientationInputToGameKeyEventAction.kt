...
open public class RightOrientationInputToGameKeyEventAction :
    ...
    companion object {
        ...
        : GameKeyCompleteMotionGestureInputEvent {
            ...
            if (
                RightOrientationInputToGameKeyEventAction.instance ==
                    NullUtil.getInstance()!!.NULL_OBJECT
            ) {
                RightOrientationInputToGameKeyEventAction.instance =
                    RightOrientationInputToGameKeyEventAction()
            }
    ...
    private constructor() :
        super(
            "Right Action",
            OrientationMotionGestureFactory.getInstance()!!.RIGHT,

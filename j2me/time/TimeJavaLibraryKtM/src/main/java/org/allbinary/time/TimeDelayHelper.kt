...
open public class TimeDelayHelper : Object {
    ...
    public constructor(delay: Int) : super() {
        // var delay = delay
        this.delay = delay
    ...
    open fun toStringAt(
        ...
        if (elapsed > 0) {
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return StringMaker()
                .append(commonLabels!!.START)!!
                .appendlong(this.startTime)!!
                .append(commonLabels!!.CURRENT)!!
                .appendlong(currentTime)!!
                .append(commonLabels!!.ELAPSED)!!
                .append(elapsedAsString)!!
                .toString()
        } else {

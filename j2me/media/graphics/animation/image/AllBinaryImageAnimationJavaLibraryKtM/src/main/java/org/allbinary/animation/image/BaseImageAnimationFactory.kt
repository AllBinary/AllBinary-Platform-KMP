...
open public class BaseImageAnimationFactory : Object, AnimationInterfaceFactoryInterface {

    companion object {

        @Throws(Exception::class)
        open fun createFactoryBase(
            image: Image,
            ...
            return BaseImageAnimationFactory(
                image,
                sequenceArray,
                width,
                height,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (this.scaleProperties!!.shouldScale) {
            ...
            this.scaleProperties!!.scaleWidth =
                (this.animationFactoryInitializationVisitor!!.width * this.scaleProperties!!.scaleX)
                    .toInt()
            this.scaleProperties!!.scaleHeight =
                (this.animationFactoryInitializationVisitor!!.height *
                        this.scaleProperties!!.scaleY)
                    .toInt()
        } else {}
    }

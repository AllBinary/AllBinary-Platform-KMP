...
open public class PreciseConstantVelocityMovement : BasicConstantVelocityMovement {
    ...
    public constructor(
        basicDecimal: BasicDecimal,
        velocityProperties: BasicVelocityProperties,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.accumulatedX =
            (this.accumulatedX + velocityProperties!!.getVelocityXBasicDecimalP()!!.getUnscaled())
                .toInt()
        this.accumulatedY =
            (this.accumulatedY + velocityProperties!!.getVelocityYBasicDecimalP()!!.getUnscaled())
                .toInt()
        this.accumulatedZ =
            (this.accumulatedZ + velocityProperties!!.getVelocityZBasicDecimalP()!!.getUnscaled())
                .toInt()
        layer.moveDXYZ(

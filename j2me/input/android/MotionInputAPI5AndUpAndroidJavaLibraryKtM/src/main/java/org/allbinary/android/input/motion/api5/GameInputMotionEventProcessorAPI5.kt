...
this.motionRecognizerArray[index]= AllMotionRecognizer()
    ...
    open fun isValid(pointerId: Int)
...
ForcedLogUtil.log(message +motionEvent!!.getPointerCount(), this)
    ...
    var x: Int = ((motionEvent!!.getX(pointerIndex) -this.displayInfo!!.getLeft()) /scalableListener!!.getRatio(this.displayInfo!!.getRatio())).toInt()


    var y: Int = ((motionEvent!!.getY(pointerIndex) -this.displayInfo!!.getTop()) /scalableListener!!.getRatio(this.displayInfo!!.getRatio())).toInt()

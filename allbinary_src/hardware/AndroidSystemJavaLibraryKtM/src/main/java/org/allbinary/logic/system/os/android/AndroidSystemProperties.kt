...
open public class AndroidSystemProperties : Object {

    companion object {

        private val SINGLETON: AndroidSystemProperties =
            AndroidSystemProperties(ResourceUtil.getInstance()!!.getContext())

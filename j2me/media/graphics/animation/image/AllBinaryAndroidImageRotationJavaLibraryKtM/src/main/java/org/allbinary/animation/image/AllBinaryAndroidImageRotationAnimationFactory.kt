...
androidImageRotationAnimationFactory!!.init(dx, dy)
    ...
    open fun createFactoryADXY(image: Image, width: Int, height: Int, dx: Int, dy: Int, angleIncrement: Short, animationBehaviorFactory: AnimationBehaviorFactory, resizeCanvasForRotation: Boolean)
        //nullable = true from not(false or (false and false)) = true
: AllBinaryAndroidImageRotationAnimationFactory{
    //var image = image
    //var width = width
    ...
    var androidImageRotationAnimationFactory: AllBinaryAndroidImageRotationAnimationFactory = AllBinaryAndroidImageRotationAnimationFactory(image, width, height, angleIncrement, animationBehaviorFactory, resizeCanvasForRotation)

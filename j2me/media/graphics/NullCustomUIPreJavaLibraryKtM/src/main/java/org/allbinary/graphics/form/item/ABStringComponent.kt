...
open public class ABStringComponent
            : Object
         {
        
companion object {
            
    val NULL_STRING_COMPONENT: ABStringComponent = ABStringComponent(BasicColorFactory.getInstance()!!.BLACK, BasicColorFactory.getInstance()!!.WHITE)

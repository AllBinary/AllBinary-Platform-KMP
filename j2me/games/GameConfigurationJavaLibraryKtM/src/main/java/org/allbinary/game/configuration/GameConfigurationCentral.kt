...
open public class GameConfigurationCentral : Object {
    ...
    private constructor() : super() {
        ...
        this.DURABILITY_CHALLENGE_LEVEL =
            GameConfiguration(
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        try {
            ...
            if (list.size() > 0) {
                ...
                this.SCALE.setValue(
                    smallIntegerSingletonFactory!!.getAt(Integer.valueOf(value)!!.toInt())
                )
            } else {

...
open public class SpecialAnalogRightTriggerGameInputProcessor : SpecialGameInputProcessor {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.collidableDestroyableDamageableLayer!!.rightTrigger(

...
open public class AdjustedImageArrayRotationAnimation : ImageArrayRotationAnimation {
    ...
    companion object {
        ...
        open fun createAdjustedImageArrayRotationAnimationInfo(
            anyType: Any,
            ...
            var imageRotationAnimationInfo: ImageArrayRotationAnimationInfo =
                anyType as ImageArrayRotationAnimationInfo

            // if statement needs to be on the same line and ternary does not work the same way.
            return AdjustedImageArrayRotationAnimation(
                imageRotationAnimationInfo!!.getImageArray(),
                imageRotationAnimationInfo!!.getAngleInfoP(),
                imageRotationAnimationInfo!!.getTotalAngle(),
                imageRotationAnimationInfo!!.getDx(),
                imageRotationAnimationInfo!!.getDy(),
                animationBehavior,
            )
        }
        ...
        open fun createAnimation(
            ...
            return AdjustedImageArrayRotationAnimation(
                ...
                angleInfo,
                totalAngle,
                -(imageArray[0]!!.getWidth() shr 2),
                -(imageArray[0]!!.getHeight() shr 2),
                animationBehavior,
            )
        }
    }

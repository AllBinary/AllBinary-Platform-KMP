...
open public class UnitItemArrayFactory : Object, ItemArraySingletonFactoryInterface {
    ...
    protected constructor(resources: Array<BasicGameResources?>) : super() {
        var resources = resources
        this.resources = resources
    }

    @Throws(Exception::class)
    open fun createFlagItem(
        flagResources: FlagGameResources,
    ...
    open fun createNamedFlagItem(
        ...
        var item: ABCustomItem =
            LayerInterfaceFactoryImageItem(
                name,
                image,
                ImageItem.LAYOUT_DEFAULT,
                flagResources!!.NAME,
                this.basicColor,
                arrayOf(RTSLayerTextAnimation(RTSGameStrings.getInstance()!!.DRAGGABLE, image)),

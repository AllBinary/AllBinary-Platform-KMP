...
open public class VirtualKeyboardEventHandler : BasicEventHandler {
    ...
    val HIDE_EVENT: VirtualKeyboardEvent =
        VirtualKeyboardEvent(BooleanFactory.getInstance()!!.FALSE)
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var virtualKeyboardEventListenerInterface: VirtualKeyboardEventListenerInterface =
            eventListenerInterface as VirtualKeyboardEventListenerInterface

        virtualKeyboardEventListenerInterface!!.onVirtualKeyboardEvent(
            eventObject as VirtualKeyboardEvent
        )
    }

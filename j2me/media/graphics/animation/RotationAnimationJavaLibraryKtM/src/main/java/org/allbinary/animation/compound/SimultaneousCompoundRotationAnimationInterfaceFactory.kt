...
open public class SimultaneousCompoundRotationAnimationInterfaceFactory :
    CompoundAnimationInterfaceFactory {
    ...
    override fun createAnimation(
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return SimultaneousCompoundRotationAnimation(
            animationInterfaceArray as Array<RotationAnimation?>,

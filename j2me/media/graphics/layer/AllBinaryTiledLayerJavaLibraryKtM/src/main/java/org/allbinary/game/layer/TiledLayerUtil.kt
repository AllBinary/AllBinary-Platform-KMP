...
open public class TiledLayerUtil : Object {
    ...
    open fun keepOnBorderdMapX(
        terrainTiledLayer: AllBinaryTiledLayer,
        x: Int,
        width: Int,
        mapBorderBufferWidth: Int,
    )
    ...
    open fun keepOnBorderdMapY(
        terrainTiledLayer: AllBinaryTiledLayer,
        y: Int,
        height: Int,
        mapBorderBufferHeight: Int,
    )
        // nullable = true from not(false or (false and false)) = true
        : Int {
        var terrainTiledLayer = terrainTiledLayer

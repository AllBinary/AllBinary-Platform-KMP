...
open public class InputProbability : Object {

    companion object {

        var INPUT_PROBABILITY: Integer = SmallIntegerSingletonFactory.getInstance()!!.getAt(0)!!
    }
    ...
    public constructor(
        likelyhoodIntegerArray: Array<Array<Integer?>?>,
        repeatLikelyhoodIntegerArray: Array<Integer?>,
        max: Int,

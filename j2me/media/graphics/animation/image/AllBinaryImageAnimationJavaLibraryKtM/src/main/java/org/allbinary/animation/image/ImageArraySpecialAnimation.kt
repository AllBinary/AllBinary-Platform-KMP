...
open public class ImageArraySpecialAnimation : ImageArrayAnimation, SpecialAnimationInterface {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var y = y
        x =
            DisplayInfoSingleton.getInstance()!!.getLastHalfWidth() -
                (this.getImage(this.circularIndexUtil!!.getIndex())!!.getWidth() shr 1)
        y = 5

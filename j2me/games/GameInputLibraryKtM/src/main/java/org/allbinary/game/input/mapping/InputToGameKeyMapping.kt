...
open public class InputToGameKeyMapping : InputMapping {
    ...
    private val mappedGameKeys: Array<GameKey?> =
        arrayOf(
    ...
    private val platformToGameKeyMapping: Array<GameKey?> =
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                ...
                .append(StringUtil.getInstance()!!.toString(input))!!
                .append(" == ")!!
                .append(StringUtil.getInstance()!!.toString(mappedToInput))!!
                .toString(),
            this,
    ...
    @Throws(Exception::class)
    open fun getSmallestCanvasGameKeyCode(
        canvas: Canvas
    )
        // nullable = true from not(false or (false and false)) = true
        : Int {
    ...
    open fun getInstanceForCanvas(
        ...
        } else if (id < 0 && -id < this.negativePlatformToGameKeyMapping!!.size) {

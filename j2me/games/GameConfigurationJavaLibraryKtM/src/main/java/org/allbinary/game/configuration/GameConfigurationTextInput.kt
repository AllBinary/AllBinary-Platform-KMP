...
open public class GameConfigurationTextInput : Object {
    ...
    companion object {
        ...
        var SIMULATOR_PORT: GameConfigurationTextInput =
            GameConfigurationTextInput("Port: ", "8010")
            ...
            // nullable = true from not(false or (false and false)) = true
        {
            ...
            var gameConfigurationTextInput: GameConfigurationTextInput =
                GameConfigurationTextInput.hashtable.get(anyType as Object)
    ...
    public constructor(label: String, text: String) : super() {
        var label = label
        var text = text
        this.setText(text)
        this.setLabel(label)

...
interface PathFindingLayerInterface :
    WaypointLayerInterface,
    ...
    @Throws(Exception::class) open fun handleCost(ownerLayer: PathFindingLayerInterface)
    ...
    @Throws(Exception::class) open fun setTarget(targetGameLayer: PathFindingLayerInterface)

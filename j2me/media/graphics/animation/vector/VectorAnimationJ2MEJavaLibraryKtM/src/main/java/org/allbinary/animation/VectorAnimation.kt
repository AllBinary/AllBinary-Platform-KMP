...
open public class VectorAnimation : IndexedAnimation, VectorAnimationInterface {

    companion object {

        open fun createVectorAnimation(
            currentPoints2: Array<IntArray?>,
            ...
            var currentPoints: Array<Array<IntArray?>?> =
                Array(1) { Array(currentPoints2!!.size) { IntArray(2) } }
    ...
    private var currentPoints: Array<Array<IntArray?>?> =
        NullUtil.getInstance()!!.NULL_INT_ARRAY_ARRAY_ARRAY

    private var circularIndexUtil: CircularIndexUtil = CircularIndexUtil.createInstance(0)!!

    public constructor(
        currentPoints: Array<Array<IntArray?>?>,
        basicColor: BasicColor,
        animationBehavior: AnimationBehavior,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        try {
            ...
            var currentPointsFrame: Array<IntArray?> =
                this.currentPoints[this.circularIndexUtil!!.getIndex()]!!

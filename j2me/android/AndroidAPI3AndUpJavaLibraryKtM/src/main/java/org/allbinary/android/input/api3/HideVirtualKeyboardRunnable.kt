...
open public class HideVirtualKeyboardRunnable : Object, Runnable {

    val logUtil: LogUtil = LogUtil.getInstance()!!

    private val activity: Activity

    public constructor(activity: Activity) : super() {
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        try {
            ...
            var viewCompositeInterface: ViewCompositeInterface =
                this.activity as ViewCompositeInterface
            ...
            if (view.getWindowToken() == null) {
                ...
                this.logUtil!!.putF(
                    "Unable to hide virtual keyboard as window token is null - This usually happens during loading when the view is not attached to a window",
                    this,
                    commonStrings!!.RUN,
                )

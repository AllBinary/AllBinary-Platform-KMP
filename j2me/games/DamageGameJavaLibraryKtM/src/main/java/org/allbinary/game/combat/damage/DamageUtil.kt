...
open public class DamageUtil : Object {
    ...
    open fun process(
        ...
        damageableInterface2: DamageableInterface,
    )
    ...
    @Throws(Exception::class)
    open fun debugDamage(
        collidableInterfaceCompositeInterface1: CollidableCompositeLayer,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (damage > 20000) {
            ...
            this.logUtil!!.putF(
                ...
                collidableInterfaceCompositeInterface1,
                this.COLLIDE,
            )
        }
    }

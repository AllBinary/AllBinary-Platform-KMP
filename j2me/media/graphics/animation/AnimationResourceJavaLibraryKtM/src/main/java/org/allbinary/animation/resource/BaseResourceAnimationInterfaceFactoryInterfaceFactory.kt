...
open public class BaseResourceAnimationInterfaceFactoryInterfaceFactory :
    Object, FeatureResourceAnimationInterfaceFactoryInterface {

    val logUtil: LogUtil = LogUtil.getInstance()!!

    val commonStrings: CommonStrings = CommonStrings.getInstance()!!

    private val hashtable: ABHashtable<Any, Any>

    private val rectangleHashtable: ABHashtable<Any, Any>

    private val rectangleArrayOfArraysHashtable: ABHashtable<Any, Any>
    ...
    public constructor(
        ...
        rectangleHashtable: ABHashtable<Any, Any>,
        rectangleArrayHashtable: ABHashtable<Any, Any>,
    ) : super() {
        // var name = name
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append("Available List of Animations: ")!!
    ...
    open fun add(
        resource: String,
        animationInterfaceFactoryInterface: BasicAnimationInterfaceFactoryInterface,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (this.hashtable.containsKey(resource as Object)) {
            ...
            throw Exception(
                StringMaker().append("Resource Already Created: ")!!.append(resource)!!.toString()
            )
        }
    ...
    @Throws(Exception::class)
    override fun getBasicAnimationInterfaceFactoryInstance(
        resource: String
    )
        // nullable = true from not(false or (false and false)) = true
        ...
        var basicAnimationInterfaceFactoryInterfaceCanBeNull: Any? =
            this.hashtable.get(resource as Object)
        ...
        return basicAnimationInterfaceFactoryInterfaceCanBeNull
            as BasicAnimationInterfaceFactoryInterface
    }

    @Throws(Exception::class)
    override fun getRectangle(
        resource: String
    )
        // nullable = true from not(false or (false and false)) = true
        : Rectangle {
    ...
    @Throws(Exception::class)
    override fun getRectangleArrayOfArrays(
        resource: String
    )
        // nullable = true from not(false or (false and false)) = true
        ...
        return this.rectangleArrayOfArraysHashtable!!.get(resource as Object)
            as Array<Array<Rectangle?>?>
    }

    @Throws(Exception::class)
    open fun addRectangleArrayOfArrays(
        resource: String,
        rectangleArrayOfArrays: Array<Array<Rectangle?>?>,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        // var resource = resource
    ...
    : String {
        ...
        return StringMaker()
            ...
            .append(CommonSeps.getInstance()!!.SEMICOLON)!!

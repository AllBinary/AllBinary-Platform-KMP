...
open public class LocalPlayerInputIdFactory : Object {
    ...
    open fun getPlayerForDevice(
        ...
        if (deviceId < this.MAX_FAST_DEVICEID) {
            ...
            this.logUtil!!.putF(
                StringMaker()
                    .append("Added DeviceId: ")!!
                    .appendint(deviceId)!!
                    .append(" beyond fast Id list")!!
                    .toString(),
                this,
                "getPlayerForDevice",
            )
        ...
        this.logUtil!!.putF(
            StringMaker()
                ...
                .appendint(index)!!
                .append(" Total: ")!!
                .appendint(this.totalDevicesMapped)!!
                .toString(),
            this,
            "getPlayerForDevice",
        )
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append("Setting PlayerInPlay with playerInputId: ")!!
                .appendint(playerInputId)!!
                .toString(),
            this,
            "setPlayerInPlay",
        )
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            StringMaker()
                .append("Setting PlayerOutOfPlay with playerInputId: ")!!
                .appendint(playerInputId)!!
                .toString(),
            this,
            "setPlayerOutOfPlay",

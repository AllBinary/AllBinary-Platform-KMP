...
interface WaypointLayerInterface {
    ...
    open fun getMoveOutOfBuildAreaPath(
        geographicMapCellPosition: GeographicMapCellPosition
    )
        // nullable = true from not(false or (false and false)) = true
        : BasicArrayList

    @Throws(Exception::class) open fun setClosestGeographicMapCellHistory(pathsList: BasicArrayList)
    ...
    @Throws(Exception::class) open fun setLoad(resource: Int)
    ...
    @Throws(Exception::class) open fun trackTo(reason: String)

    // nullable = true from not(false or (false and false)) = true

    @Throws(Exception::class) open fun trackToDXY(dx: Int, dy: Int)

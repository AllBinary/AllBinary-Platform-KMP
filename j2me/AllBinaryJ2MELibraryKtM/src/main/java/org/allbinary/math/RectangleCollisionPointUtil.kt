...
open public class RectangleCollisionPointUtil : Object {

    companion object {

        open fun allPointsInside(
            rectX1: Int,
            rectY1: Int,
            rectX2: Int,
            rectY2: Int,
            ...
            var rectangleCollisionUtil: RectangleCollisionUtil =
            ...
            for (index in list.size()!! - 1 downTo 0) {
                ...
                if (
                    !rectangleCollisionUtil!!.isInside(
                        rectX1,
                        rectY1,
                        rectX2,
                        rectY2,

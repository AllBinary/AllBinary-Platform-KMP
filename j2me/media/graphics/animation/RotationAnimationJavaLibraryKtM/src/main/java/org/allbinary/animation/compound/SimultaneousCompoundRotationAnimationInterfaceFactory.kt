...
open public class SimultaneousCompoundRotationAnimationInterfaceFactory : CompoundAnimationInterfaceFactory {
...
: Animation
    ...
    //var animationInterfaceArray = animationInterfaceArray
                        ...
                        //if statement needs to be on the same line and ternary does not work the same way.
                        return SimultaneousCompoundRotationAnimation(animationInterfaceArray as Array<RotationAnimation?>, this.animationBehaviorFactory!!.getOrCreateInstance())
}

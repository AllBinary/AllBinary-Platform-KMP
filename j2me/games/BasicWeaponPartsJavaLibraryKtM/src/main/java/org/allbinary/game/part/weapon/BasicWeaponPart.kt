...
open public class BasicWeaponPart : Object, PartInterface, SalvoInterface {

    companion object {

        open fun createBasicWeaponPart(
        ...
        val NULL_BASIC_WEAPON_PART: BasicWeaponPart =
            BasicWeaponPart.createBasicWeaponPart(

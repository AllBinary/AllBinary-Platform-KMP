...
open public class VectorRotationGenerator : Object {
    ...
    open fun getInstance(
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return this.getInstanceFrames(
            vectorRotationInfo!!.getWidth(),
            vectorRotationInfo!!.getHeight(),
            vectorRotationInfo!!.getPoints(),
            vectorRotationInfo!!.getTotalFrames(),
        )
    }

    private val angleFactory: AngleFactory = AngleFactory.getInstance()!!

    open fun getInstanceFrames(
        width: Int,
        height: Int,
        ...
        try {
            ...
            while (index < totalAngle) {
                pointsBasicArrayList!!.add(
                    this.getListAtAngle(
                        width,
                        height,
                        pointBasicArrayList,
                        this.angleFactory!!.getAt(index),
                    )
                )

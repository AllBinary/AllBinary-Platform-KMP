...
open public class PtsDamageFloaters : DamageFloaters {
    ...
    companion object {
        ...
        private val basicColorArrayIndexer: BasicColorArrayIndexer =
            BasicColorArrayIndexer(
                arrayOf(
        ...
        for (index in this.lastDamage!!.size - 1 downTo 0) {
            ...
            if (this.lastDamage[index] != 0) {
                ...
                this.basicSetColorUtil!!.setBasicColorP(
                    graphics,
                    PtsDamageFloaters.basicColorArrayIndexer!!.get(),
                )
                graphics.drawChars(
                    this.lastDamageString[index]!!,
                    0,
                    this.lastDamageStringSizeArray[index]!!,
                    x - this.myRandomFactory!!.getNextInt(delta),
                    y - delta,
                    0,
                )

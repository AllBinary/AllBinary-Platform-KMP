...
open public class AllBinaryCollisionManager : Object {

    companion object {

        private var allBinaryCollisionManager: AllBinaryCollisionManager =
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        for (index in startIndex + 1 until size) {
            ...
            var collidableInterfaceCompositeInterface2: CollidableInterfaceCompositeInterface =
                layerManager!!.getLayerAt(index) as CollidableInterfaceCompositeInterface
    ...
    open fun collide(
        layerManager: LayerManager,
        collidableInterfaceCompositeInterface: CollidableInterfaceCompositeInterface,
        collidableInterfaceCompositeInterface2: CollidableInterfaceCompositeInterface,
    )
        // nullable = true from not(false or (false and false)) = true
    {
        var layerManager = layerManager
        ...
        var collidableBase: CollidableBaseBehavior =
            collidableInterfaceCompositeInterface!!.getCollidableInferface()!!

        if (
            collidableBase2!!.isCollidable(
                collidableInterfaceCompositeInterface as CollidableCompositeLayer
            )
        ) {

            if (
                collidableBase!!.isCollisionInterface(
                    collidableInterfaceCompositeInterface as CollidableCompositeLayer,
                    collidableInterfaceCompositeInterface2,
                )
            ) {
                collidableBase!!.collideInterface(
                    collidableInterfaceCompositeInterface as CollidableCompositeLayer,
                    collidableInterfaceCompositeInterface2,
                )
                collidableBase2!!.collideInterface(
                    collidableInterfaceCompositeInterface as CollidableCompositeLayer,
                    collidableInterfaceCompositeInterface,
                )
            }

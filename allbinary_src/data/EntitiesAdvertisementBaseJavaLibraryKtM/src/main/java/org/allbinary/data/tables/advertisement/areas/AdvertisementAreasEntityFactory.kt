...
open public class AdvertisementAreasEntityFactory
            : Object
         {
...
: AdvertisementAreasEntityInterface{
    var logUtil: LogUtil = LogUtil.getInstance()!!
        ...
        try {
                        ...
                        return AdvertisementAreasEntity() as AdvertisementAreasEntityInterface
} catch(e: Exception)
            {
...
logUtil!!.put(commonStrings!!.EXCEPTION, 
                            "AdvertisementAreasEntityFactory", commonStrings!!.GET_INSTANCE, e)

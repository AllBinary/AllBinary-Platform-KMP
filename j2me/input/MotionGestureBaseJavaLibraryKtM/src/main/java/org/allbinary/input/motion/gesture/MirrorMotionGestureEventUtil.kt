...
open public class MirrorMotionGestureEventUtil : Object {
    ...
    open fun mirrorVerticle(
        ...
        var mirroredPreviousPoint: GPoint =
            pointFactory!!.createXY(
                previousNewX,
                motionGestureEvent!!.getPreviousPoint()!!.getY(),
            )!!

        var mirroredCurrentPoint: GPoint =
            pointFactory!!.createXY(currentNewX, motionGestureEvent!!.getCurrentPoint()!!.getY())!!

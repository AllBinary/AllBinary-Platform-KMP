...
open public class TouchScreenTypeFactory : Object {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var touchScreenTypesFactory: TouchScreenTypesFactory =
        ...
        if (touchScreen == Configuration.TOUCHSCREEN_FINGER) {
            ...
            if (!touchScreenFactory!!.isTouch()) {
                ...
                PreLogUtil.put(
                    "Not Really Exception: This indicates that a touch screen does exist but is not API8 so we will try it",
                    this,

...
open public class PlayerGameInputGameLayer : AllBinaryGameLayer, PlayerGameInputCompositeInterface {
    ...
    public constructor(
        ...
        Rectangle(PointFactory.getInstance()!!.ZERO_ZERO, 0, 0),
        StaticViewPosition(0, 0, 0),
    ) {
        ...
        this.playerGameInput =
            PlayerGameInput(this.getGameKeyEventList(), BasicArrayListD(), playerInputId)

        var canvasStrings: CanvasStrings = CanvasStrings.getInstance()!!

        this.logUtil!!.putF(
            "Danger Danger Danger: Should Not Be Called Except For Testing Input",
            this,
            canvasStrings!!.PAINT,
        )
    }

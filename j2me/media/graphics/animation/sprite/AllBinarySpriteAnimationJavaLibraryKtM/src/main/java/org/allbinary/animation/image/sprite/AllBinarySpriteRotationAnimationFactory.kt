...
open public class AllBinarySpriteRotationAnimationFactory :
    BaseImageAnimationFactory, ProceduralAnimationInterfaceFactoryInterface {
    ...
    companion object {
        ...
        open fun createWHDY(
            ...
            var spriteRotationAnimationFactory: AllBinarySpriteRotationAnimationFactory =
                AllBinarySpriteRotationAnimationFactory(
                    image,
        ...
        open fun createWH(
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinarySpriteRotationAnimationFactory.createWHDY(
                image,
                0,
                0,
                animationBehaviorFactory,
        ...
        open fun createQ(
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinarySpriteRotationAnimationFactory(
                image,
                PrimitiveIntUtil.getArrayInstance(),
                (image.getHeight() shr 2),
                (image.getHeight() shr 2),
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.animationFactoryInitializationVisitor!!.dx +=
            -this.animationFactoryInitializationVisitor!!.width / 5
        this.animationFactoryInitializationVisitor!!.dy +=
            -this.animationFactoryInitializationVisitor!!.height / 5
    }
    ...
    override fun getInstance(
        ...
        if (
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinaryAdjustedSpriteRotationAnimation(
                sprite,
                this.getImage(),
                this.animationFactoryInitializationVisitor!!.dx,
                this.animationFactoryInitializationVisitor!!.dy,
            ...
            // if statement needs to be on the same line and ternary does not work the same way.
            return AllBinarySpriteRotationAnimation(
                sprite,
                this.getImage(),
                this.animationBehaviorFactory!!.getOrCreateInstance(),
            )

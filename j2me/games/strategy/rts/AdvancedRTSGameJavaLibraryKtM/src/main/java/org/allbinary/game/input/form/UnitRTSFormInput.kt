...
open public class UnitRTSFormInput : RTSFormInput {
    ...
    public constructor(groupInterface: Array<Group?>) : super(groupInterface) {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.newUnitGameNotificationEvent!!.setBasicColorP(
            geographicMapInterface!!.getForegroundBasicColor()
        )
    }
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var geographicMapCellPosition: GeographicMapCellPosition =
            geographicMapCellPositionArea!!.getNextSurroundingGeographicMapCellPosition()!!

        this.getHashtable()!!.put(Layer.ID, associatedRtsLayer)
        this.getHashtable()!!.put(
            UnitRTSFormInput.DECAL_ID,
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (cost <= capital.getTotalMoney()) {
            ...
            AssignWaypointsUtil.getInstance()!!.set(
                layerInterface as UnitLayer,
                associatedRtsLayer as AdvancedRTSGameLayer,
            )

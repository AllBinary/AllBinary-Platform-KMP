...
open public class GameLevelDisplayChangeEventListenersFactory : Object {

    companion object {

        private val instance: GameLevelDisplayChangeEventListenersFactory =
        ...
        // nullable = true from not(false or (false and true)) = true
    {
        ...
        for (index in this.list.size()!! - 1 downTo 0) {
            ...
            displayChangeEventListener =
                this.list.objectArray[index]!! as DisplayChangeEventListener

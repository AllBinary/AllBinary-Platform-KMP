...
open public class GameAdState : GameAdStateBase, VirtualKeyboardEventListenerInterface {

    public constructor(adConfiguration: AdConfiguration) : super(adConfiguration) {

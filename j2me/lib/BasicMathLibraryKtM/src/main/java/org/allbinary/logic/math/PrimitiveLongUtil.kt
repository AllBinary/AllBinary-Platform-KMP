...
open public class PrimitiveLongUtil : Object {

    companion object {

        open fun createPowerOfTen(
            powerOfTen: Int
        )
            ...
            var primitiveLongUtil: PrimitiveLongUtil =
                PrimitiveLongUtil(powerOfTen, NullUtil.getInstance()!!.NULL_OBJECT)
            ...
            if (powerOfTen % 10 != 0) {
                ...
                logUtil!!.put(
                    ...
                    Exception("Max must be power of 10"),
                )
            }
    ...
    public constructor(powerOfTen: Int, unused: Any) : super() {
        var powerOfTen = powerOfTen
        var unused = unused
    ...
    open fun getCharArray(
        ...
        while (div >= 1) {
            ...
            if (digit >= 0 && digit < 10) {
                ...
                if (digit == 0 && index == 0) {} else {

                    this.charArray[index++] =
                        this.primitiveLongSingleton!!.NUMBER_CHAR_ARRAY[digit]!!
                }

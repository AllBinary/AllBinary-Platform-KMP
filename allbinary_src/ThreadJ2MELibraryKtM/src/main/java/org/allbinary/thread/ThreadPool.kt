...
open public class ThreadPool : Object {
    ...
    private var taskQueue: BasicArrayList =
    ...
    public constructor(poolName: String, numThreads: Int, priority: Int) : super() {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        // mutex.withLock
        {
            ...
            if (task != null) {
                ...
                var lowerPriorityRunnable: PriorityRunnable =
                    this.threadObjectUtil!!.NULL_PRIORITY_RUNNABLE

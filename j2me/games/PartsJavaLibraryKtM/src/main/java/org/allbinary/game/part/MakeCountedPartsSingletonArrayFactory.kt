...
open public class MakeCountedPartsSingletonArrayFactory : Object {

    companion object {

        private val instance: MakeCountedPartsSingletonArrayFactory =
    ...
    open fun getUpdated(
        ...
        var countedBasicArrayList: BasicArrayList =
        ...
        for (index in 0 until size) {
            ...
            layerInterfaceFactoryInterface =
                countedBasicArrayList!!.objectArray[index]!! as CountedPickedUpLayerInterfaceFactory

...
open public class DisplayChangeEventHandler : BasicEventHandler {

    companion object {

        private val SINGLETON: DisplayChangeEventHandler = DisplayChangeEventHandler()

        open fun getInstance()
        // nullable =  from not(true or (false and true)) =
        : DisplayChangeEventHandler {

...
open public class GameNotificationEventHandler : BasicEventHandler {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var gameNotificationListenerInterface: GameNotificationListenerInterface =
            eventListenerInterface as GameNotificationListenerInterface

        gameNotificationListenerInterface!!.onGameNotificationEvent(
            eventObject as GameNotificationEvent
        )
    }
}

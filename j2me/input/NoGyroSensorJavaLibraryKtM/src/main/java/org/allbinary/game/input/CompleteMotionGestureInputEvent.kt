...
open public class CompleteMotionGestureInputEvent :
    AllBinaryEventObject, CompleteMotionGestureInputInterface {

    val logUtil: LogUtil = LogUtil.getInstance()!!

    private var name: String = StringUtil.getInstance()!!.EMPTY_STRING

    private var motionGestureInput: MotionGestureInput =

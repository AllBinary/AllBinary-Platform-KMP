...
open public class LastDisplayChangeEventHandler : BasicEventHandler {

    companion object {

        private val SINGLETON: LastDisplayChangeEventHandler = LastDisplayChangeEventHandler()

        open fun getInstance()
        // nullable =  from not(true or (false and true)) =
        : LastDisplayChangeEventHandler {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var displayChangeEventListener: DisplayChangeEventListener =
            (eventListenerInterface as DisplayChangeEventListener)

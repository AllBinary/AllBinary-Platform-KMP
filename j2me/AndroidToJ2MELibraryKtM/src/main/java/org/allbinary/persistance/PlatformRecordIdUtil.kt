...
open public class PlatformRecordIdUtil : Object {
    ...
    private val PLATFORM_SHORT_NAME: String = "AND"
    ...
    open fun getRecordId(
        ...
        // if statement needs to be on the same line and ternary does not work the same way.
        return StringMaker()
            .append(abeClientInformation!!.toShortString())!!
            .append(CommonSeps.getInstance()!!.UNDERSCORE)!!
            .append(this.PLATFORM_SHORT_NAME)!!
            .append(baseRecordId)!!
            .toString()
    }
}

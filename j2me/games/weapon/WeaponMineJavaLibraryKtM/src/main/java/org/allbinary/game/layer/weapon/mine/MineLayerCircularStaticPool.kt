...
open public class MineLayerCircularStaticPool : Object {

    companion object {

        private var WEAPON_LAYER_CIRCULAR_STATIC_POOL: WeaponLayerCircularPool =
            ...
            // nullable = true from not(false or (false and false)) = true
        {
            ...
            MineLayerCircularStaticPool.WEAPON_LAYER_CIRCULAR_STATIC_POOL
                .initAllBinaryLayerCircularPool(MineLayerFactory(viewPositionFactoryInterface), 20)
        }

...
open public class OnDemandLoader : Object {

    private val onDemandResourcesFactory: OnDemandResourcesFactory

    private val gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory:
        GameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory

    private val resourceAnimationInterfaceFactoryInterfaceFactory:
    ...
    public constructor(
        ...
        var gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory =
            gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory
        var resourceAnimationInterfaceFactoryInterfaceFactory =
            resourceAnimationInterfaceFactoryInterfaceFactory
        this.onDemandResourcesFactory = onDemandResourcesFactory
        this.gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory =
            gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (Features.getInstance()!!.isFeature(MainFeatureFactory.getInstance()!!.LOAD_ALL)) {
            ...
            var layerPlacementInterfaceBasicArrayListFactoryInterface:
                LayerPlacementInterfaceBasicArrayListFactoryInterface =
                this.gameLayerPlacementInterfaceBasicArrayListFactoryInterfaceFactory!!.getInstance(
                    level
                )!!
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        var onDemandArray: IntArray =
            layerPlacementInterfaceBasicArrayListFactoryInterface!!.getOnDemandResources()!!

        PreLogUtil.put(
            StringMaker()
                .append(commonStrings!!.START)!!
                .appendint(onDemandArray!!.size)!!
                .toString(),
            this,
            "initLevel",
        )
        ...
        for (onDemandIndex in onDemandArray!!.size - 1 downTo 0) {
            ...
            onDemandResources =
                this.onDemandResourcesFactory!!.remove(onDemandArray[onDemandIndex]!!)

...
open public class GameInitializationUtil : Object {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (
            ChangedGameFeatureListener.getInstance()!!.isChangedFeature(mainFeatureFactory!!.STATIC)
        ) {

            var gameInitializationInterface: GameInitializationInterface =

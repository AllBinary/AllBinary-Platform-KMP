...
open public class DisplayInfoSingleton : Object {
    ...
    val ADJUSTING_FOR_SCALING_IN_PORTRAIT: String =
        "Adjusting for Scaling in portrait display ratio: "

    val ADJUSTING_FOR_SCALING_IN_LANDSCAPE: String =
        "Adjusting for Scaling in landscape display ratio: "
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            stringMaker!!
                ...
                .toString(),
            this,
            this.SET_LAST_SIZE_METHOD_NAME,
        )
        ...
        this.logUtil!!.putF(
            stringMaker!!
                .append(this.FULL_WIDTH)!!
                .appendint(aFullWidth)!!
                .append(this.FULL_HEIGHT)!!
                .appendint(aFullHeight)!!
        ...
        if (operatingSystemInterface!!.isScalable()) {
            ...
            if (this.isPortraitWH(aLastWidth, aLastHeight)) {
                ...
                if (aLastHeight > this.scaleLargestTo) {
                    ...
                    this.logUtil!!.putF(
                        stringMaker!!
                            .append(this.ADJUSTING_FOR_SCALING_IN_PORTRAIT)!!
                            .appendfloat(this.displayRatio)!!
                            .toString(),
                        this,
                        this.SET_LAST_SIZE_METHOD_NAME,
                    )
                ...
                if (aLastWidth > this.scaleLargestTo) {
                    ...
                    this.logUtil!!.putF(
                        stringMaker!!
                            .append(this.ADJUSTING_FOR_SCALING_IN_LANDSCAPE)!!
                            .appendfloat(this.displayRatio)!!
                            .toString(),
                        this,
                        this.SET_LAST_SIZE_METHOD_NAME,
        ...
        this.logUtil!!.putF(
            stringMaker!!
                .append(this.LAST_WIDTH)!!
                .appendint(aLastWidth)!!
                .append(this.LAST_HEIGHT)!!
                .appendint(aLastHeight)!!
                .toString(),
            this,
            this.SET_LAST_SIZE_METHOD_NAME,
        )
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        this.logUtil!!.putF(
            stringMaker!!.append(this.REASON)!!.append(reason)!!.toString(),
            this,
            this.FIRE_METHOD_NAME,
        )
        stringMaker!!.delete(0, stringMaker!!.length())
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (aLastWidth > 0 && aLastHeight > 0) {
            ...
            if (
                ...
                stringMaker!!.delete(0, stringMaker!!.length())
                this.logUtil!!.putF(
                    stringMaker!!.append(this.UPDATE_FROM_ORIENTATION_CHANGE)!!.toString(),
                    this,
                    this.commonStrings!!.UPDATE,
                )
                ...
                if (operatingSystemInterface!!.isOverScan()) {
                    ...
                    aLastWidth = aLastWidth * operatingSystemInterface!!.getOverScanXPercent() / 100
                    aLastHeight =
                        aLastHeight * operatingSystemInterface!!.getOverScanYPercent() / 100
                }
                ...
                this.logUtil!!.putF(
                    stringMaker!!
                        .append(this.UPDATE_FROM_ORIENTATION_CHANGE)!!
                        .append(this.LAST_WIDTH)!!
                        .appendint(aLastWidth)!!
                        .append(this.LAST_HEIGHT)!!
                        .appendint(aLastHeight)!!

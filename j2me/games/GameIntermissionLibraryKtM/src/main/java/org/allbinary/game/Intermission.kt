...
open public class Intermission : Object, IntermissionInterface {

    private var enabled: Boolean = false

    private val timeElapsedHelper: TimeDelayHelper = TimeDelayHelper(0)

    private var intermissionEnableListener: IntermissionEnableListenerInterface =
        NullIntermissionEnableListener.getInstance()!!

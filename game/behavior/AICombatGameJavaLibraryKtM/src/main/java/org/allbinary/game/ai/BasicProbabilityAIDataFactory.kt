...
open public class BasicProbabilityAIDataFactory : Object {
    ...
    : Hashtable<Any, Any> {
        ...
        var likelyhoodIntegerArray: Array<Array<Integer?>?> =
            Array(Canvas.KEY_NUM9 + 1) { arrayOfNulls<Integer?>(2) }
        ...
        var inputProbability: InputProbability =
            InputProbability(
                likelyhoodIntegerArray,
                repeatLikelyhoodIntegerArray,
                42,
                NoTimeDelayHelper.SINGLETON,
            )

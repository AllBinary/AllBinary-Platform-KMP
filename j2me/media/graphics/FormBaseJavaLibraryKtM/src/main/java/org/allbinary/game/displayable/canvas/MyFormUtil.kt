...
open public class MyFormUtil : Object {
        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (displayInfo!!.getLastHeight() < 320) {
            ...
            this.popupMenuRectangle =
                Rectangle(pointFactory!!.createXY(0, 25), width, (font.getHeight() * 4) + 2)
        } else {
            this.popupMenuRectangle =
                Rectangle(
                    pointFactory!!.createXY(0, displayInfo!!.getLastHalfHeight() - 70),
                    width,
                    (font.getHeight() * 5),
                )
        }

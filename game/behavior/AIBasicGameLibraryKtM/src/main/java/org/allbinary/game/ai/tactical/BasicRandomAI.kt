        ...
        // nullable = true from not(false or (false and false)) = true
    {
        ...
        if (
            this.inputProbability!!
                .getTimeDelayHelper()!!
                .isTime(GameTickTimeDelayHelperFactory.getInstance()!!.startTime)
        ) {
            this.i_random =
                this.myRandomFactory!!.getAbsoluteNextInt(this.inputProbability!!.getMax())

            var repeat: Boolean = false

            var repeatLikelyhoodIntegerArray: Array<Integer?> =
                this.inputProbability!!.getRepeatLikelyhoodIntegerArray()!!

            if (
                this.getLastKey() != -1 &&
                    repeatLikelyhoodIntegerArray[this.getLastKey()]!!.toInt() >= this.i_random
            ) {
                repeat = true
            }
            ...
            if (!repeat) {
                ...
                var likelyhoodIntegerArray: Array<Array<Integer?>?> =
                ...
                for (index in 0 until size) {
                    ...
                    if (
                        likelyhoodIntegerArray!!.size >= key && likelyhoodIntegerKeyArray[0] != null
                    ) {

                        if (
                            this.i_random >= likelyhoodIntegerKeyArray[0]!!.toInt() &&
                                this.i_random < likelyhoodIntegerKeyArray[1]!!.toInt()
                        ) {
                            this.setLastKey(key)
                            break
                        }
